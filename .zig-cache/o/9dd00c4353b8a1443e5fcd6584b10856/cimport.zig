...
pub inline fn SDL_size_add_check_overflow(arg_a: usize, arg_b: usize, arg_ret: [*c]usize) bool {
    ...
    ret.* = a +% b;
    return @"true" != 0;
} // /usr/include/SDL3/SDL_stdinc.h:6149:13: warning: TODO implement function '__builtin_add_overflow' in std.zig.c_builtins
// /usr/include/SDL3/SDL_stdinc.h:6147:23: warning: unable to translate function, demoted to extern
...
pub const alloca = @compileError("unable to translate macro: undefined identifier `__builtin_alloca`"); // /usr/include/SDL3/SDL_stdinc.h:117:12
pub const SDL_SIZE_MAX = SIZE_MAX;
pub const SDL_COMPILE_TIME_ASSERT = @compileError("unable to translate C expr: unexpected token '_Static_assert'"); // /usr/include/SDL3/SDL_stdinc.h:230:9
...
pub const SDL_STRINGIFY_ARG = @compileError("unable to translate C expr: unexpected token ''"); // /usr/include/SDL3/SDL_stdinc.h:261:9
...
pub const SDL_PRINTF_VARARG_FUNC = @compileError("unable to translate macro: undefined identifier `format`"); // /usr/include/SDL3/SDL_stdinc.h:1151:9
pub const SDL_PRINTF_VARARG_FUNCV = @compileError("unable to translate macro: undefined identifier `format`"); // /usr/include/SDL3/SDL_stdinc.h:1152:9
pub const SDL_SCANF_VARARG_FUNC = @compileError("unable to translate macro: undefined identifier `format`"); // /usr/include/SDL3/SDL_stdinc.h:1153:9
pub const SDL_SCANF_VARARG_FUNCV = @compileError("unable to translate macro: undefined identifier `format`"); // /usr/include/SDL3/SDL_stdinc.h:1154:9
...
pub const SDL_RESTRICT = @compileError("unable to translate C expr: unexpected token 'restrict'"); // /usr/include/SDL3/SDL_begin_code.h:331:13
pub inline fn SDL_HAS_BUILTIN(x: anytype) @TypeOf(__builtin.has_builtin(x)) {
    _ = &x;
    return __builtin.has_builtin(x);
}
pub const SDL_DEPRECATED = @compileError("unable to translate macro: undefined identifier `deprecated`"); // /usr/include/SDL3/SDL_begin_code.h:349:13
pub const SDL_UNUSED = @compileError("unable to translate macro: undefined identifier `unused`"); // /usr/include/SDL3/SDL_begin_code.h:359:13
pub const SDL_DECLSPEC = @compileError("unable to translate macro: undefined identifier `visibility`"); // /usr/include/SDL3/SDL_begin_code.h:375:12
pub const SDLCALL = "";
pub const SDL_INLINE = @compileError("unable to translate C expr: unexpected token '__inline__'"); // /usr/include/SDL3/SDL_begin_code.h:416:9
pub const SDL_FORCE_INLINE = @compileError("unable to translate macro: undefined identifier `always_inline`"); // /usr/include/SDL3/SDL_begin_code.h:437:9
pub const SDL_NORETURN = @compileError("unable to translate macro: undefined identifier `noreturn`"); // /usr/include/SDL3/SDL_begin_code.h:445:9
pub const SDL_ANALYZER_NORETURN = "";
pub const SDL_FALLTHROUGH = @compileError("unable to translate macro: undefined identifier `__fallthrough__`"); // /usr/include/SDL3/SDL_begin_code.h:487:9
pub const SDL_NODISCARD = @compileError("unable to translate macro: undefined identifier `warn_unused_result`"); // /usr/include/SDL3/SDL_begin_code.h:500:9
pub const SDL_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // /usr/include/SDL3/SDL_begin_code.h:510:9
pub const SDL_ALLOC_SIZE = @compileError("unable to translate macro: undefined identifier `alloc_size`"); // /usr/include/SDL3/SDL_begin_code.h:522:9
pub const SDL_ALLOC_SIZE2 = @compileError("unable to translate macro: undefined identifier `alloc_size`"); // /usr/include/SDL3/SDL_begin_code.h:532:9
pub const SDL_ALIGNED = @compileError("unable to translate macro: undefined identifier `aligned`"); // /usr/include/SDL3/SDL_begin_code.h:542:9
pub const SDL_INIT_INTERFACE = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/SDL3/SDL_stdinc.h:1256:9
...
pub const SDL_copyp = @compileError("unable to translate C expr: unexpected token '{'"); // /usr/include/SDL3/SDL_stdinc.h:2540:9
...
pub const SDL_iconv_wchar_utf8 = @compileError("unable to translate C expr: unexpected token 'const'"); // /usr/include/SDL3/SDL_stdinc.h:5997:9
...
pub const SDL_FUNCTION = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /usr/include/SDL3/SDL_assert.h:176:12
pub const SDL_FILE = @compileError("unable to translate macro: undefined identifier `__FILE__`"); // /usr/include/SDL3/SDL_assert.h:202:9
pub const SDL_ASSERT_FILE = SDL_FILE;
pub const SDL_LINE = @compileError("unable to translate macro: undefined identifier `__LINE__`"); // /usr/include/SDL3/SDL_assert.h:232:9
pub const SDL_NULL_WHILE_LOOP_CONDITION = @as(c_int, 0);
pub const SDL_disabled_assert = @compileError("unable to translate C expr: unexpected token 'do'"); // /usr/include/SDL3/SDL_assert.h:293:9
pub inline fn SDL_AssertBreakpoint() @TypeOf(SDL_TriggerBreakpoint()) {
    return SDL_TriggerBreakpoint();
}
pub const SDL_enabled_assert = @compileError("unable to translate macro: undefined identifier `sdl_assert_data`"); // /usr/include/SDL3/SDL_assert.h:400:9
...
pub const SDL_CompilerBarrier = @compileError("unable to translate macro: undefined identifier `__atomic_signal_fence`"); // /usr/include/SDL3/SDL_atomic.h:160:9
pub const SDL_MemoryBarrierRelease = @compileError("unable to translate macro: undefined identifier `__atomic_thread_fence`"); // /usr/include/SDL3/SDL_atomic.h:282:9
pub const SDL_MemoryBarrierAcquire = @compileError("unable to translate macro: undefined identifier `__atomic_thread_fence`"); // /usr/include/SDL3/SDL_atomic.h:283:9
pub const SDL_CPUPauseInstruction = @compileError("unable to translate C expr: unexpected token '__asm__'"); // /usr/include/SDL3/SDL_atomic.h:359:13
...
pub const SDL_ELF_NOTE_DLOPEN_VENDOR = "FDO";
pub const SDL_ELF_NOTE_DLOPEN_TYPE = __helpers.promoteIntLiteral(c_uint, 0x407c0c0a, .hex);
pub const SDL_ELF_NOTE_INTERNAL2 = @compileError("unable to translate macro: undefined identifier `aligned`"); // /usr/include/SDL3/SDL_dlopennote.h:123:9
pub inline fn SDL_ELF_NOTE_INTERNAL(json: anytype, variable_name: anytype) @TypeOf(SDL_ELF_NOTE_INTERNAL2(json, variable_name)) {
    _ = &json;
    _ = &variable_name;
    return SDL_ELF_NOTE_INTERNAL2(json, variable_name);
}
pub inline fn SDL_DLNOTE_JSON_ARRAY1(N1: anytype) @TypeOf("[\"" ++ N1 ++ "\"]") {
    _ = &N1;
    return "[\"" ++ N1 ++ "\"]";
}
pub inline fn SDL_DLNOTE_JSON_ARRAY2(N1: anytype, N2: anytype) @TypeOf("[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\"]") {
    _ = &N1;
    _ = &N2;
    return "[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\"]";
}
pub inline fn SDL_DLNOTE_JSON_ARRAY3(N1: anytype, N2: anytype, N3: anytype) @TypeOf("[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\",\"" ++ N3 ++ "\"]") {
    _ = &N1;
    _ = &N2;
    _ = &N3;
    return "[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\",\"" ++ N3 ++ "\"]";
}
pub inline fn SDL_DLNOTE_JSON_ARRAY4(N1: anytype, N2: anytype, N3: anytype, N4: anytype) @TypeOf("[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\",\"" ++ N3 ++ "\",\"" ++ N4 ++ "\"]") {
    _ = &N1;
    _ = &N2;
    _ = &N3;
    _ = &N4;
...
pub inline fn SDL_DLNOTE_JSON_ARRAY5(N1: anytype, N2: anytype, N3: anytype, N4: anytype, N5: anytype) @TypeOf("[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\",\"" ++ N3 ++ "\",\"" ++ N4 ++ "\",\"" ++ N5 ++ "\"]") {
    _ = &N1;
    _ = &N2;
    _ = &N3;
    _ = &N4;
...
pub inline fn SDL_DLNOTE_JSON_ARRAY6(N1: anytype, N2: anytype, N3: anytype, N4: anytype, N5: anytype, N6: anytype) @TypeOf("[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\",\"" ++ N3 ++ "\",\"" ++ N4 ++ "\",\"" ++ N5 ++ "\",\"" ++ N6 ++ "\"]") {
    _ = &N1;
    _ = &N2;
    _ = &N3;
    _ = &N4;
...
pub inline fn SDL_DLNOTE_JSON_ARRAY7(N1: anytype, N2: anytype, N3: anytype, N4: anytype, N5: anytype, N6: anytype, N7: anytype) @TypeOf("[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\",\"" ++ N3 ++ "\",\"" ++ N4 ++ "\",\"" ++ N5 ++ "\",\"" ++ N6 ++ "\",\"" ++ N7 ++ "\"]") {
    _ = &N1;
    _ = &N2;
    _ = &N3;
    _ = &N4;
...
pub inline fn SDL_DLNOTE_JSON_ARRAY8(N1: anytype, N2: anytype, N3: anytype, N4: anytype, N5: anytype, N6: anytype, N7: anytype, N8: anytype) @TypeOf("[\"" ++ N1 ++ "\",\"" ++ N2 ++ "\",\"" ++ N3 ++ "\",\"" ++ N4 ++ "\",\"" ++ N5 ++ "\",\"" ++ N6 ++ "\",\"" ++ N7 ++ "\",\"" ++ N8 ++ "\"]") {
    _ = &N1;
    _ = &N2;
    _ = &N3;
    _ = &N4;
...
pub inline fn SDL_DLNOTE_JSON_ARRAY_GET(N1: anytype, N2: anytype, N3: anytype, N4: anytype, N5: anytype, N6: anytype, N7: anytype, N8: anytype, NAME: anytype) @TypeOf(NAME) {
    _ = &N1;
    _ = &N2;
    _ = &N3;
    _ = &N4;
...
pub const SDL_DLNOTE_JSON_ARRAY = @compileError("unable to translate C expr: unexpected token '__VA_ARGS__'"); // /usr/include/SDL3/SDL_dlopennote.h:155:9
pub const SDL_DLNOTE_JOIN2 = @compileError("unable to translate C expr: unexpected token '##'"); // /usr/include/SDL3/SDL_dlopennote.h:171:9
pub inline fn SDL_DLNOTE_JOIN(A: anytype, B: anytype) @TypeOf(SDL_DLNOTE_JOIN2(A, B)) {
    _ = &A;
    _ = &B;
    return SDL_DLNOTE_JOIN2(A, B);
}
pub const SDL_DLNOTE_UNIQUE_NAME = @compileError("unable to translate macro: undefined identifier `s_SDL_dlopen_note_`"); // /usr/include/SDL3/SDL_dlopennote.h:173:9
pub const SDL_ELF_NOTE_DLOPEN = @compileError("unable to translate C expr: unexpected token '__VA_ARGS__'"); // /usr/include/SDL3/SDL_dlopennote.h:212:9
...
pub const SDL_HINT_ENABLE_STEAM_SCREEN_KEYBOARD = "SDL_ENABLE_STEAM_SCREEN_KEYBOARD";
...
pub const SDL_MICRO_VERSION = @as(c_int, 12);
...
pub const SDL_WINDOWEVENT = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_deprecated_use_SDL_EVENT_WINDOW_NAME`"); // /usr/include/SDL3/SDL_oldnames.h:799:9
pub const SDL_WINDOWEVENT_CLOSE = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_CLOSE_renamed_SDL_EVENT_WINDOW_CLOSE_REQUESTED`"); // /usr/include/SDL3/SDL_oldnames.h:800:9
pub const SDL_WINDOWEVENT_DISPLAY_CHANGED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_DISPLAY_CHANGED_renamed_SDL_EVENT_WINDOW_DISPLAY_CHANGED`"); // /usr/include/SDL3/SDL_oldnames.h:801:9
pub const SDL_WINDOWEVENT_ENTER = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_ENTER_renamed_SDL_EVENT_WINDOW_MOUSE_ENTER`"); // /usr/include/SDL3/SDL_oldnames.h:802:9
pub const SDL_WINDOWEVENT_EXPOSED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_EXPOSED_renamed_SDL_EVENT_WINDOW_EXPOSED`"); // /usr/include/SDL3/SDL_oldnames.h:803:9
pub const SDL_WINDOWEVENT_FOCUS_GAINED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_FOCUS_GAINED_renamed_SDL_EVENT_WINDOW_FOCUS_GAINED`"); // /usr/include/SDL3/SDL_oldnames.h:804:9
pub const SDL_WINDOWEVENT_FOCUS_LOST = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_FOCUS_LOST_renamed_SDL_EVENT_WINDOW_FOCUS_LOST`"); // /usr/include/SDL3/SDL_oldnames.h:805:9
pub const SDL_WINDOWEVENT_HIDDEN = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_HIDDEN_renamed_SDL_EVENT_WINDOW_HIDDEN`"); // /usr/include/SDL3/SDL_oldnames.h:806:9
pub const SDL_WINDOWEVENT_HIT_TEST = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_HIT_TEST_renamed_SDL_EVENT_WINDOW_HIT_TEST`"); // /usr/include/SDL3/SDL_oldnames.h:807:9
pub const SDL_WINDOWEVENT_ICCPROF_CHANGED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_ICCPROF_CHANGED_renamed_SDL_EVENT_WINDOW_ICCPROF_CHANGED`"); // /usr/include/SDL3/SDL_oldnames.h:808:9
pub const SDL_WINDOWEVENT_LEAVE = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_LEAVE_renamed_SDL_EVENT_WINDOW_MOUSE_LEAVE`"); // /usr/include/SDL3/SDL_oldnames.h:809:9
pub const SDL_WINDOWEVENT_MAXIMIZED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_MAXIMIZED_renamed_SDL_EVENT_WINDOW_MAXIMIZED`"); // /usr/include/SDL3/SDL_oldnames.h:810:9
pub const SDL_WINDOWEVENT_MINIMIZED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_MINIMIZED_renamed_SDL_EVENT_WINDOW_MINIMIZED`"); // /usr/include/SDL3/SDL_oldnames.h:811:9
pub const SDL_WINDOWEVENT_MOVED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_MOVED_renamed_SDL_EVENT_WINDOW_MOVED`"); // /usr/include/SDL3/SDL_oldnames.h:812:9
pub const SDL_WINDOWEVENT_RESIZED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_RESIZED_renamed_SDL_EVENT_WINDOW_RESIZED`"); // /usr/include/SDL3/SDL_oldnames.h:813:9
pub const SDL_WINDOWEVENT_RESTORED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_RESTORED_renamed_SDL_EVENT_WINDOW_RESTORED`"); // /usr/include/SDL3/SDL_oldnames.h:814:9
pub const SDL_WINDOWEVENT_SHOWN = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_SHOWN_renamed_SDL_EVENT_WINDOW_SHOWN`"); // /usr/include/SDL3/SDL_oldnames.h:815:9
pub const SDL_WINDOWEVENT_SIZE_CHANGED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOWEVENT_SIZE_CHANGED_renamed_SDL_EVENT_WINDOW_PIXEL_SIZE_CHANGED`"); // /usr/include/SDL3/SDL_oldnames.h:816:9
pub const SDL_eventaction = @compileError("unable to translate macro: undefined identifier `SDL_eventaction_renamed_SDL_EventAction`"); // /usr/include/SDL3/SDL_oldnames.h:817:9
pub const SDL_CONTROLLER_AXIS_INVALID = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_INVALID_renamed_SDL_GAMEPAD_AXIS_INVALID`"); // /usr/include/SDL3/SDL_oldnames.h:820:9
pub const SDL_CONTROLLER_AXIS_LEFTX = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_LEFTX_renamed_SDL_GAMEPAD_AXIS_LEFTX`"); // /usr/include/SDL3/SDL_oldnames.h:821:9
pub const SDL_CONTROLLER_AXIS_LEFTY = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_LEFTY_renamed_SDL_GAMEPAD_AXIS_LEFTY`"); // /usr/include/SDL3/SDL_oldnames.h:822:9
pub const SDL_CONTROLLER_AXIS_MAX = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_MAX_renamed_SDL_GAMEPAD_AXIS_COUNT`"); // /usr/include/SDL3/SDL_oldnames.h:823:9
pub const SDL_CONTROLLER_AXIS_RIGHTX = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_RIGHTX_renamed_SDL_GAMEPAD_AXIS_RIGHTX`"); // /usr/include/SDL3/SDL_oldnames.h:824:9
pub const SDL_CONTROLLER_AXIS_RIGHTY = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_RIGHTY_renamed_SDL_GAMEPAD_AXIS_RIGHTY`"); // /usr/include/SDL3/SDL_oldnames.h:825:9
pub const SDL_CONTROLLER_AXIS_TRIGGERLEFT = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_TRIGGERLEFT_renamed_SDL_GAMEPAD_AXIS_LEFT_TRIGGER`"); // /usr/include/SDL3/SDL_oldnames.h:826:9
pub const SDL_CONTROLLER_AXIS_TRIGGERRIGHT = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_AXIS_TRIGGERRIGHT_renamed_SDL_GAMEPAD_AXIS_RIGHT_TRIGGER`"); // /usr/include/SDL3/SDL_oldnames.h:827:9
pub const SDL_CONTROLLER_BINDTYPE_AXIS = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BINDTYPE_AXIS_renamed_SDL_GAMEPAD_BINDTYPE_AXIS`"); // /usr/include/SDL3/SDL_oldnames.h:828:9
pub const SDL_CONTROLLER_BINDTYPE_BUTTON = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BINDTYPE_BUTTON_renamed_SDL_GAMEPAD_BINDTYPE_BUTTON`"); // /usr/include/SDL3/SDL_oldnames.h:829:9
pub const SDL_CONTROLLER_BINDTYPE_HAT = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BINDTYPE_HAT_renamed_SDL_GAMEPAD_BINDTYPE_HAT`"); // /usr/include/SDL3/SDL_oldnames.h:830:9
pub const SDL_CONTROLLER_BINDTYPE_NONE = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BINDTYPE_NONE_renamed_SDL_GAMEPAD_BINDTYPE_NONE`"); // /usr/include/SDL3/SDL_oldnames.h:831:9
pub const SDL_CONTROLLER_BUTTON_A = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_A_renamed_SDL_GAMEPAD_BUTTON_SOUTH`"); // /usr/include/SDL3/SDL_oldnames.h:832:9
pub const SDL_CONTROLLER_BUTTON_B = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_B_renamed_SDL_GAMEPAD_BUTTON_EAST`"); // /usr/include/SDL3/SDL_oldnames.h:833:9
pub const SDL_CONTROLLER_BUTTON_BACK = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_BACK_renamed_SDL_GAMEPAD_BUTTON_BACK`"); // /usr/include/SDL3/SDL_oldnames.h:834:9
pub const SDL_CONTROLLER_BUTTON_DPAD_DOWN = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_DPAD_DOWN_renamed_SDL_GAMEPAD_BUTTON_DPAD_DOWN`"); // /usr/include/SDL3/SDL_oldnames.h:835:9
pub const SDL_CONTROLLER_BUTTON_DPAD_LEFT = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_DPAD_LEFT_renamed_SDL_GAMEPAD_BUTTON_DPAD_LEFT`"); // /usr/include/SDL3/SDL_oldnames.h:836:9
pub const SDL_CONTROLLER_BUTTON_DPAD_RIGHT = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_DPAD_RIGHT_renamed_SDL_GAMEPAD_BUTTON_DPAD_RIGHT`"); // /usr/include/SDL3/SDL_oldnames.h:837:9
pub const SDL_CONTROLLER_BUTTON_DPAD_UP = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_DPAD_UP_renamed_SDL_GAMEPAD_BUTTON_DPAD_UP`"); // /usr/include/SDL3/SDL_oldnames.h:838:9
pub const SDL_CONTROLLER_BUTTON_GUIDE = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_GUIDE_renamed_SDL_GAMEPAD_BUTTON_GUIDE`"); // /usr/include/SDL3/SDL_oldnames.h:839:9
pub const SDL_CONTROLLER_BUTTON_INVALID = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_INVALID_renamed_SDL_GAMEPAD_BUTTON_INVALID`"); // /usr/include/SDL3/SDL_oldnames.h:840:9
pub const SDL_CONTROLLER_BUTTON_LEFTSHOULDER = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_LEFTSHOULDER_renamed_SDL_GAMEPAD_BUTTON_LEFT_SHOULDER`"); // /usr/include/SDL3/SDL_oldnames.h:841:9
pub const SDL_CONTROLLER_BUTTON_LEFTSTICK = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_LEFTSTICK_renamed_SDL_GAMEPAD_BUTTON_LEFT_STICK`"); // /usr/include/SDL3/SDL_oldnames.h:842:9
pub const SDL_CONTROLLER_BUTTON_MAX = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_MAX_renamed_SDL_GAMEPAD_BUTTON_COUNT`"); // /usr/include/SDL3/SDL_oldnames.h:843:9
pub const SDL_CONTROLLER_BUTTON_MISC1 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_MISC1_renamed_SDL_GAMEPAD_BUTTON_MISC1`"); // /usr/include/SDL3/SDL_oldnames.h:844:9
pub const SDL_CONTROLLER_BUTTON_PADDLE1 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_PADDLE1_renamed_SDL_GAMEPAD_BUTTON_RIGHT_PADDLE1`"); // /usr/include/SDL3/SDL_oldnames.h:845:9
pub const SDL_CONTROLLER_BUTTON_PADDLE2 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_PADDLE2_renamed_SDL_GAMEPAD_BUTTON_LEFT_PADDLE1`"); // /usr/include/SDL3/SDL_oldnames.h:846:9
pub const SDL_CONTROLLER_BUTTON_PADDLE3 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_PADDLE3_renamed_SDL_GAMEPAD_BUTTON_RIGHT_PADDLE2`"); // /usr/include/SDL3/SDL_oldnames.h:847:9
pub const SDL_CONTROLLER_BUTTON_PADDLE4 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_PADDLE4_renamed_SDL_GAMEPAD_BUTTON_LEFT_PADDLE2`"); // /usr/include/SDL3/SDL_oldnames.h:848:9
pub const SDL_CONTROLLER_BUTTON_RIGHTSHOULDER = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_RIGHTSHOULDER_renamed_SDL_GAMEPAD_BUTTON_RIGHT_SHOULDER`"); // /usr/include/SDL3/SDL_oldnames.h:849:9
pub const SDL_CONTROLLER_BUTTON_RIGHTSTICK = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_RIGHTSTICK_renamed_SDL_GAMEPAD_BUTTON_RIGHT_STICK`"); // /usr/include/SDL3/SDL_oldnames.h:850:9
pub const SDL_CONTROLLER_BUTTON_START = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_START_renamed_SDL_GAMEPAD_BUTTON_START`"); // /usr/include/SDL3/SDL_oldnames.h:851:9
pub const SDL_CONTROLLER_BUTTON_TOUCHPAD = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_TOUCHPAD_renamed_SDL_GAMEPAD_BUTTON_TOUCHPAD`"); // /usr/include/SDL3/SDL_oldnames.h:852:9
pub const SDL_CONTROLLER_BUTTON_X = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_X_renamed_SDL_GAMEPAD_BUTTON_WEST`"); // /usr/include/SDL3/SDL_oldnames.h:853:9
pub const SDL_CONTROLLER_BUTTON_Y = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_BUTTON_Y_renamed_SDL_GAMEPAD_BUTTON_NORTH`"); // /usr/include/SDL3/SDL_oldnames.h:854:9
pub const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_LEFT = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_LEFT_renamed_SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_LEFT`"); // /usr/include/SDL3/SDL_oldnames.h:855:9
pub const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_PAIR = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_PAIR_renamed_SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_PAIR`"); // /usr/include/SDL3/SDL_oldnames.h:856:9
pub const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT_renamed_SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_JOYCON_RIGHT`"); // /usr/include/SDL3/SDL_oldnames.h:857:9
pub const SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_PRO = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_NINTENDO_SWITCH_PRO_renamed_SDL_GAMEPAD_TYPE_NINTENDO_SWITCH_PRO`"); // /usr/include/SDL3/SDL_oldnames.h:858:9
pub const SDL_CONTROLLER_TYPE_PS3 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_PS3_renamed_SDL_GAMEPAD_TYPE_PS3`"); // /usr/include/SDL3/SDL_oldnames.h:859:9
pub const SDL_CONTROLLER_TYPE_PS4 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_PS4_renamed_SDL_GAMEPAD_TYPE_PS4`"); // /usr/include/SDL3/SDL_oldnames.h:860:9
pub const SDL_CONTROLLER_TYPE_PS5 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_PS5_renamed_SDL_GAMEPAD_TYPE_PS5`"); // /usr/include/SDL3/SDL_oldnames.h:861:9
pub const SDL_CONTROLLER_TYPE_UNKNOWN = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_UNKNOWN_renamed_SDL_GAMEPAD_TYPE_STANDARD`"); // /usr/include/SDL3/SDL_oldnames.h:862:9
pub const SDL_CONTROLLER_TYPE_VIRTUAL = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_VIRTUAL_renamed_SDL_GAMEPAD_TYPE_VIRTUAL`"); // /usr/include/SDL3/SDL_oldnames.h:863:9
pub const SDL_CONTROLLER_TYPE_XBOX360 = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_XBOX360_renamed_SDL_GAMEPAD_TYPE_XBOX360`"); // /usr/include/SDL3/SDL_oldnames.h:864:9
pub const SDL_CONTROLLER_TYPE_XBOXONE = @compileError("unable to translate macro: undefined identifier `SDL_CONTROLLER_TYPE_XBOXONE_renamed_SDL_GAMEPAD_TYPE_XBOXONE`"); // /usr/include/SDL3/SDL_oldnames.h:865:9
pub const SDL_GameController = @compileError("unable to translate macro: undefined identifier `SDL_GameController_renamed_SDL_Gamepad`"); // /usr/include/SDL3/SDL_oldnames.h:866:9
pub const SDL_GameControllerAddMapping = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerAddMapping_renamed_SDL_AddGamepadMapping`"); // /usr/include/SDL3/SDL_oldnames.h:867:9
pub const SDL_GameControllerAddMappingsFromFile = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerAddMappingsFromFile_renamed_SDL_AddGamepadMappingsFromFile`"); // /usr/include/SDL3/SDL_oldnames.h:868:9
pub const SDL_GameControllerAddMappingsFromRW = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerAddMappingsFromRW_renamed_SDL_AddGamepadMappingsFromIO`"); // /usr/include/SDL3/SDL_oldnames.h:869:9
pub const SDL_GameControllerAxis = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerAxis_renamed_SDL_GamepadAxis`"); // /usr/include/SDL3/SDL_oldnames.h:870:9
pub const SDL_GameControllerBindType = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerBindType_renamed_SDL_GamepadBindingType`"); // /usr/include/SDL3/SDL_oldnames.h:871:9
pub const SDL_GameControllerButton = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerButton_renamed_SDL_GamepadButton`"); // /usr/include/SDL3/SDL_oldnames.h:872:9
pub const SDL_GameControllerClose = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerClose_renamed_SDL_CloseGamepad`"); // /usr/include/SDL3/SDL_oldnames.h:873:9
pub const SDL_GameControllerEventState = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerEventState_deprecated_use_SDL_SetGamepadEventsEnabled_true_false`"); // /usr/include/SDL3/SDL_oldnames.h:874:9
pub const SDL_GameControllerFromInstanceID = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerFromInstanceID_renamed_SDL_GetGamepadFromID`"); // /usr/include/SDL3/SDL_oldnames.h:875:9
pub const SDL_GameControllerFromPlayerIndex = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerFromPlayerIndex_renamed_SDL_GetGamepadFromPlayerIndex`"); // /usr/include/SDL3/SDL_oldnames.h:876:9
pub const SDL_GameControllerGetAppleSFSymbolsNameForAxis = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetAppleSFSymbolsNameForAxis_renamed_SDL_GetGamepadAppleSFSymbolsNameForAxis`"); // /usr/include/SDL3/SDL_oldnames.h:877:9
pub const SDL_GameControllerGetAppleSFSymbolsNameForButton = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetAppleSFSymbolsNameForButton_renamed_SDL_GetGamepadAppleSFSymbolsNameForButton`"); // /usr/include/SDL3/SDL_oldnames.h:878:9
pub const SDL_GameControllerGetAttached = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetAttached_renamed_SDL_GamepadConnected`"); // /usr/include/SDL3/SDL_oldnames.h:879:9
pub const SDL_GameControllerGetAxis = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetAxis_renamed_SDL_GetGamepadAxis`"); // /usr/include/SDL3/SDL_oldnames.h:880:9
pub const SDL_GameControllerGetAxisFromString = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetAxisFromString_renamed_SDL_GetGamepadAxisFromString`"); // /usr/include/SDL3/SDL_oldnames.h:881:9
pub const SDL_GameControllerGetButton = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetButton_renamed_SDL_GetGamepadButton`"); // /usr/include/SDL3/SDL_oldnames.h:882:9
pub const SDL_GameControllerGetButtonFromString = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetButtonFromString_renamed_SDL_GetGamepadButtonFromString`"); // /usr/include/SDL3/SDL_oldnames.h:883:9
pub const SDL_GameControllerGetFirmwareVersion = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetFirmwareVersion_renamed_SDL_GetGamepadFirmwareVersion`"); // /usr/include/SDL3/SDL_oldnames.h:884:9
pub const SDL_GameControllerGetJoystick = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetJoystick_renamed_SDL_GetGamepadJoystick`"); // /usr/include/SDL3/SDL_oldnames.h:885:9
pub const SDL_GameControllerGetNumTouchpadFingers = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetNumTouchpadFingers_renamed_SDL_GetNumGamepadTouchpadFingers`"); // /usr/include/SDL3/SDL_oldnames.h:886:9
pub const SDL_GameControllerGetNumTouchpads = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetNumTouchpads_renamed_SDL_GetNumGamepadTouchpads`"); // /usr/include/SDL3/SDL_oldnames.h:887:9
pub const SDL_GameControllerGetPlayerIndex = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetPlayerIndex_renamed_SDL_GetGamepadPlayerIndex`"); // /usr/include/SDL3/SDL_oldnames.h:888:9
pub const SDL_GameControllerGetProduct = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetProduct_renamed_SDL_GetGamepadProduct`"); // /usr/include/SDL3/SDL_oldnames.h:889:9
pub const SDL_GameControllerGetProductVersion = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetProductVersion_renamed_SDL_GetGamepadProductVersion`"); // /usr/include/SDL3/SDL_oldnames.h:890:9
pub const SDL_GameControllerGetSensorData = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetSensorData_renamed_SDL_GetGamepadSensorData`"); // /usr/include/SDL3/SDL_oldnames.h:891:9
pub const SDL_GameControllerGetSensorDataRate = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetSensorDataRate_renamed_SDL_GetGamepadSensorDataRate`"); // /usr/include/SDL3/SDL_oldnames.h:892:9
pub const SDL_GameControllerGetSerial = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetSerial_renamed_SDL_GetGamepadSerial`"); // /usr/include/SDL3/SDL_oldnames.h:893:9
pub const SDL_GameControllerGetSteamHandle = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetSteamHandle_renamed_SDL_GetGamepadSteamHandle`"); // /usr/include/SDL3/SDL_oldnames.h:894:9
pub const SDL_GameControllerGetStringForAxis = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetStringForAxis_renamed_SDL_GetGamepadStringForAxis`"); // /usr/include/SDL3/SDL_oldnames.h:895:9
pub const SDL_GameControllerGetStringForButton = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetStringForButton_renamed_SDL_GetGamepadStringForButton`"); // /usr/include/SDL3/SDL_oldnames.h:896:9
pub const SDL_GameControllerGetTouchpadFinger = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetTouchpadFinger_renamed_SDL_GetGamepadTouchpadFinger`"); // /usr/include/SDL3/SDL_oldnames.h:897:9
pub const SDL_GameControllerGetType = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetType_renamed_SDL_GetGamepadType`"); // /usr/include/SDL3/SDL_oldnames.h:898:9
pub const SDL_GameControllerGetVendor = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerGetVendor_renamed_SDL_GetGamepadVendor`"); // /usr/include/SDL3/SDL_oldnames.h:899:9
pub const SDL_GameControllerHasAxis = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerHasAxis_renamed_SDL_GamepadHasAxis`"); // /usr/include/SDL3/SDL_oldnames.h:900:9
pub const SDL_GameControllerHasButton = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerHasButton_renamed_SDL_GamepadHasButton`"); // /usr/include/SDL3/SDL_oldnames.h:901:9
pub const SDL_GameControllerHasSensor = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerHasSensor_renamed_SDL_GamepadHasSensor`"); // /usr/include/SDL3/SDL_oldnames.h:902:9
pub const SDL_GameControllerIsSensorEnabled = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerIsSensorEnabled_renamed_SDL_GamepadSensorEnabled`"); // /usr/include/SDL3/SDL_oldnames.h:903:9
pub const SDL_GameControllerMapping = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerMapping_renamed_SDL_GetGamepadMapping`"); // /usr/include/SDL3/SDL_oldnames.h:904:9
pub const SDL_GameControllerMappingForDeviceIndex = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerMappingForDeviceIndex_renamed_SDL_GetGamepadMappingForDeviceIndex`"); // /usr/include/SDL3/SDL_oldnames.h:905:9
pub const SDL_GameControllerMappingForGUID = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerMappingForGUID_renamed_SDL_GetGamepadMappingForGUID`"); // /usr/include/SDL3/SDL_oldnames.h:906:9
pub const SDL_GameControllerName = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerName_renamed_SDL_GetGamepadName`"); // /usr/include/SDL3/SDL_oldnames.h:907:9
pub const SDL_GameControllerOpen = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerOpen_renamed_SDL_OpenGamepad`"); // /usr/include/SDL3/SDL_oldnames.h:908:9
pub const SDL_GameControllerPath = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerPath_renamed_SDL_GetGamepadPath`"); // /usr/include/SDL3/SDL_oldnames.h:909:9
pub const SDL_GameControllerRumble = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerRumble_renamed_SDL_RumbleGamepad`"); // /usr/include/SDL3/SDL_oldnames.h:910:9
pub const SDL_GameControllerRumbleTriggers = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerRumbleTriggers_renamed_SDL_RumbleGamepadTriggers`"); // /usr/include/SDL3/SDL_oldnames.h:911:9
pub const SDL_GameControllerSendEffect = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerSendEffect_renamed_SDL_SendGamepadEffect`"); // /usr/include/SDL3/SDL_oldnames.h:912:9
pub const SDL_GameControllerSetLED = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerSetLED_renamed_SDL_SetGamepadLED`"); // /usr/include/SDL3/SDL_oldnames.h:913:9
pub const SDL_GameControllerSetPlayerIndex = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerSetPlayerIndex_renamed_SDL_SetGamepadPlayerIndex`"); // /usr/include/SDL3/SDL_oldnames.h:914:9
pub const SDL_GameControllerSetSensorEnabled = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerSetSensorEnabled_renamed_SDL_SetGamepadSensorEnabled`"); // /usr/include/SDL3/SDL_oldnames.h:915:9
pub const SDL_GameControllerType = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerType_renamed_SDL_GamepadType`"); // /usr/include/SDL3/SDL_oldnames.h:916:9
pub const SDL_GameControllerUpdate = @compileError("unable to translate macro: undefined identifier `SDL_GameControllerUpdate_renamed_SDL_UpdateGamepads`"); // /usr/include/SDL3/SDL_oldnames.h:917:9
pub const SDL_INIT_GAMECONTROLLER = @compileError("unable to translate macro: undefined identifier `SDL_INIT_GAMECONTROLLER_renamed_SDL_INIT_GAMEPAD`"); // /usr/include/SDL3/SDL_oldnames.h:918:9
pub const SDL_IsGameController = @compileError("unable to translate macro: undefined identifier `SDL_IsGameController_renamed_SDL_IsGamepad`"); // /usr/include/SDL3/SDL_oldnames.h:919:9
pub const SDL_GUIDFromString = @compileError("unable to translate macro: undefined identifier `SDL_GUIDFromString_renamed_SDL_StringToGUID`"); // /usr/include/SDL3/SDL_oldnames.h:922:9
pub const SDL_HapticClose = @compileError("unable to translate macro: undefined identifier `SDL_HapticClose_renamed_SDL_CloseHaptic`"); // /usr/include/SDL3/SDL_oldnames.h:925:9
pub const SDL_HapticDestroyEffect = @compileError("unable to translate macro: undefined identifier `SDL_HapticDestroyEffect_renamed_SDL_DestroyHapticEffect`"); // /usr/include/SDL3/SDL_oldnames.h:926:9
pub const SDL_HapticGetEffectStatus = @compileError("unable to translate macro: undefined identifier `SDL_HapticGetEffectStatus_renamed_SDL_GetHapticEffectStatus`"); // /usr/include/SDL3/SDL_oldnames.h:927:9
pub const SDL_HapticNewEffect = @compileError("unable to translate macro: undefined identifier `SDL_HapticNewEffect_renamed_SDL_CreateHapticEffect`"); // /usr/include/SDL3/SDL_oldnames.h:928:9
pub const SDL_HapticNumAxes = @compileError("unable to translate macro: undefined identifier `SDL_HapticNumAxes_renamed_SDL_GetNumHapticAxes`"); // /usr/include/SDL3/SDL_oldnames.h:929:9
pub const SDL_HapticNumEffects = @compileError("unable to translate macro: undefined identifier `SDL_HapticNumEffects_renamed_SDL_GetMaxHapticEffects`"); // /usr/include/SDL3/SDL_oldnames.h:930:9
pub const SDL_HapticNumEffectsPlaying = @compileError("unable to translate macro: undefined identifier `SDL_HapticNumEffectsPlaying_renamed_SDL_GetMaxHapticEffectsPlaying`"); // /usr/include/SDL3/SDL_oldnames.h:931:9
pub const SDL_HapticOpen = @compileError("unable to translate macro: undefined identifier `SDL_HapticOpen_renamed_SDL_OpenHaptic`"); // /usr/include/SDL3/SDL_oldnames.h:932:9
pub const SDL_HapticOpenFromJoystick = @compileError("unable to translate macro: undefined identifier `SDL_HapticOpenFromJoystick_renamed_SDL_OpenHapticFromJoystick`"); // /usr/include/SDL3/SDL_oldnames.h:933:9
pub const SDL_HapticOpenFromMouse = @compileError("unable to translate macro: undefined identifier `SDL_HapticOpenFromMouse_renamed_SDL_OpenHapticFromMouse`"); // /usr/include/SDL3/SDL_oldnames.h:934:9
pub const SDL_HapticPause = @compileError("unable to translate macro: undefined identifier `SDL_HapticPause_renamed_SDL_PauseHaptic`"); // /usr/include/SDL3/SDL_oldnames.h:935:9
pub const SDL_HapticQuery = @compileError("unable to translate macro: undefined identifier `SDL_HapticQuery_renamed_SDL_GetHapticFeatures`"); // /usr/include/SDL3/SDL_oldnames.h:936:9
pub const SDL_HapticRumbleInit = @compileError("unable to translate macro: undefined identifier `SDL_HapticRumbleInit_renamed_SDL_InitHapticRumble`"); // /usr/include/SDL3/SDL_oldnames.h:937:9
pub const SDL_HapticRumblePlay = @compileError("unable to translate macro: undefined identifier `SDL_HapticRumblePlay_renamed_SDL_PlayHapticRumble`"); // /usr/include/SDL3/SDL_oldnames.h:938:9
pub const SDL_HapticRumbleStop = @compileError("unable to translate macro: undefined identifier `SDL_HapticRumbleStop_renamed_SDL_StopHapticRumble`"); // /usr/include/SDL3/SDL_oldnames.h:939:9
pub const SDL_HapticRunEffect = @compileError("unable to translate macro: undefined identifier `SDL_HapticRunEffect_renamed_SDL_RunHapticEffect`"); // /usr/include/SDL3/SDL_oldnames.h:940:9
pub const SDL_HapticSetAutocenter = @compileError("unable to translate macro: undefined identifier `SDL_HapticSetAutocenter_renamed_SDL_SetHapticAutocenter`"); // /usr/include/SDL3/SDL_oldnames.h:941:9
pub const SDL_HapticSetGain = @compileError("unable to translate macro: undefined identifier `SDL_HapticSetGain_renamed_SDL_SetHapticGain`"); // /usr/include/SDL3/SDL_oldnames.h:942:9
pub const SDL_HapticStopAll = @compileError("unable to translate macro: undefined identifier `SDL_HapticStopAll_renamed_SDL_StopHapticEffects`"); // /usr/include/SDL3/SDL_oldnames.h:943:9
pub const SDL_HapticStopEffect = @compileError("unable to translate macro: undefined identifier `SDL_HapticStopEffect_renamed_SDL_StopHapticEffect`"); // /usr/include/SDL3/SDL_oldnames.h:944:9
pub const SDL_HapticUnpause = @compileError("unable to translate macro: undefined identifier `SDL_HapticUnpause_renamed_SDL_ResumeHaptic`"); // /usr/include/SDL3/SDL_oldnames.h:945:9
pub const SDL_HapticUpdateEffect = @compileError("unable to translate macro: undefined identifier `SDL_HapticUpdateEffect_renamed_SDL_UpdateHapticEffect`"); // /usr/include/SDL3/SDL_oldnames.h:946:9
pub const SDL_JoystickIsHaptic = @compileError("unable to translate macro: undefined identifier `SDL_JoystickIsHaptic_renamed_SDL_IsJoystickHaptic`"); // /usr/include/SDL3/SDL_oldnames.h:947:9
pub const SDL_MouseIsHaptic = @compileError("unable to translate macro: undefined identifier `SDL_MouseIsHaptic_renamed_SDL_IsMouseHaptic`"); // /usr/include/SDL3/SDL_oldnames.h:948:9
pub const SDL_DelHintCallback = @compileError("unable to translate macro: undefined identifier `SDL_DelHintCallback_renamed_SDL_RemoveHintCallback`"); // /usr/include/SDL3/SDL_oldnames.h:951:9
pub const SDL_HINT_ACCELEROMETER_AS_JOYSTICK = @compileError("unable to translate macro: undefined identifier `SDL_HINT_ACCELEROMETER_AS_JOYSTICK_deprecated_use_SDL_GamepadHasSensor_and_SDL_SetGamepadSensorEnabled`"); // /usr/include/SDL3/SDL_oldnames.h:952:9
pub const SDL_HINT_ALLOW_TOPMOST = @compileError("unable to translate macro: undefined identifier `SDL_HINT_ALLOW_TOPMOST_renamed_SDL_HINT_WINDOW_ALLOW_TOPMOST`"); // /usr/include/SDL3/SDL_oldnames.h:953:9
pub const SDL_HINT_DIRECTINPUT_ENABLED = @compileError("unable to translate macro: undefined identifier `SDL_HINT_DIRECTINPUT_ENABLED_renamed_SDL_HINT_JOYSTICK_DIRECTINPUT`"); // /usr/include/SDL3/SDL_oldnames.h:954:9
pub const SDL_HINT_GDK_TEXTINPUT_DEFAULT = @compileError("unable to translate macro: undefined identifier `SDL_HINT_GDK_TEXTINPUT_DEFAULT_renamed_SDL_HINT_GDK_TEXTINPUT_DEFAULT_TEXT`"); // /usr/include/SDL3/SDL_oldnames.h:955:9
pub const SDL_HINT_JOYSTICK_GAMECUBE_RUMBLE_BRAKE = @compileError("unable to translate macro: undefined identifier `SDL_HINT_JOYSTICK_GAMECUBE_RUMBLE_BRAKE_renamed_SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE`"); // /usr/include/SDL3/SDL_oldnames.h:956:9
pub const SDL_HINT_JOYSTICK_HIDAPI_PS4_RUMBLE = @compileError("unable to translate macro: undefined identifier `SDL_HINT_JOYSTICK_HIDAPI_PS4_RUMBLE_renamed_SDL_HINT_JOYSTICK_ENHANCED_REPORTS`"); // /usr/include/SDL3/SDL_oldnames.h:957:9
pub const SDL_HINT_JOYSTICK_HIDAPI_PS5_RUMBLE = @compileError("unable to translate macro: undefined identifier `SDL_HINT_JOYSTICK_HIDAPI_PS5_RUMBLE_renamed_SDL_HINT_JOYSTICK_ENHANCED_REPORTS`"); // /usr/include/SDL3/SDL_oldnames.h:958:9
pub const SDL_HINT_LINUX_DIGITAL_HATS = @compileError("unable to translate macro: undefined identifier `SDL_HINT_LINUX_DIGITAL_HATS_renamed_SDL_HINT_JOYSTICK_LINUX_DIGITAL_HATS`"); // /usr/include/SDL3/SDL_oldnames.h:959:9
pub const SDL_HINT_LINUX_HAT_DEADZONES = @compileError("unable to translate macro: undefined identifier `SDL_HINT_LINUX_HAT_DEADZONES_renamed_SDL_HINT_JOYSTICK_LINUX_HAT_DEADZONES`"); // /usr/include/SDL3/SDL_oldnames.h:960:9
pub const SDL_HINT_LINUX_JOYSTICK_CLASSIC = @compileError("unable to translate macro: undefined identifier `SDL_HINT_LINUX_JOYSTICK_CLASSIC_renamed_SDL_HINT_JOYSTICK_LINUX_CLASSIC`"); // /usr/include/SDL3/SDL_oldnames.h:961:9
pub const SDL_HINT_LINUX_JOYSTICK_DEADZONES = @compileError("unable to translate macro: undefined identifier `SDL_HINT_LINUX_JOYSTICK_DEADZONES_renamed_SDL_HINT_JOYSTICK_LINUX_DEADZONES`"); // /usr/include/SDL3/SDL_oldnames.h:962:9
pub const SDL_HINT_RENDER_SCALE_QUALITY = @compileError("unable to translate macro: undefined identifier `SDL_HINT_RENDER_SCALE_QUALITY_deprecated_use_SDL_SetTextureScaleMode_with_SDL_SCALEMODE_NEAREST`"); // /usr/include/SDL3/SDL_oldnames.h:963:9
pub const SDL_HINT_WINDOWS_FORCE_MUTEX_CRITICAL_SECTIONS = @compileError("unable to translate macro: undefined identifier `SDL_HINT_WINDOWS_FORCE_MUTEX_CRITICAL_SECTIONS_deprecated_remove_this_line`"); // /usr/include/SDL3/SDL_oldnames.h:964:9
pub const SDL_JOYSTICK_TYPE_GAMECONTROLLER = @compileError("unable to translate macro: undefined identifier `SDL_JOYSTICK_TYPE_GAMECONTROLLER_renamed_SDL_JOYSTICK_TYPE_GAMEPAD`"); // /usr/include/SDL3/SDL_oldnames.h:967:9
pub const SDL_JoystickAttachVirtualEx = @compileError("unable to translate macro: undefined identifier `SDL_JoystickAttachVirtualEx_renamed_SDL_AttachVirtualJoystick`"); // /usr/include/SDL3/SDL_oldnames.h:968:9
pub const SDL_JoystickClose = @compileError("unable to translate macro: undefined identifier `SDL_JoystickClose_renamed_SDL_CloseJoystick`"); // /usr/include/SDL3/SDL_oldnames.h:969:9
pub const SDL_JoystickDetachVirtual = @compileError("unable to translate macro: undefined identifier `SDL_JoystickDetachVirtual_renamed_SDL_DetachVirtualJoystick`"); // /usr/include/SDL3/SDL_oldnames.h:970:9
pub const SDL_JoystickFromInstanceID = @compileError("unable to translate macro: undefined identifier `SDL_JoystickFromInstanceID_renamed_SDL_GetJoystickFromID`"); // /usr/include/SDL3/SDL_oldnames.h:971:9
pub const SDL_JoystickFromPlayerIndex = @compileError("unable to translate macro: undefined identifier `SDL_JoystickFromPlayerIndex_renamed_SDL_GetJoystickFromPlayerIndex`"); // /usr/include/SDL3/SDL_oldnames.h:972:9
pub const SDL_JoystickGUID = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGUID_renamed_SDL_GUID`"); // /usr/include/SDL3/SDL_oldnames.h:973:9
pub const SDL_JoystickGetAttached = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetAttached_renamed_SDL_JoystickConnected`"); // /usr/include/SDL3/SDL_oldnames.h:974:9
pub const SDL_JoystickGetAxis = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetAxis_renamed_SDL_GetJoystickAxis`"); // /usr/include/SDL3/SDL_oldnames.h:975:9
pub const SDL_JoystickGetAxisInitialState = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetAxisInitialState_renamed_SDL_GetJoystickAxisInitialState`"); // /usr/include/SDL3/SDL_oldnames.h:976:9
pub const SDL_JoystickGetBall = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetBall_renamed_SDL_GetJoystickBall`"); // /usr/include/SDL3/SDL_oldnames.h:977:9
pub const SDL_JoystickGetButton = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetButton_renamed_SDL_GetJoystickButton`"); // /usr/include/SDL3/SDL_oldnames.h:978:9
pub const SDL_JoystickGetFirmwareVersion = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetFirmwareVersion_renamed_SDL_GetJoystickFirmwareVersion`"); // /usr/include/SDL3/SDL_oldnames.h:979:9
pub const SDL_JoystickGetGUID = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetGUID_renamed_SDL_GetJoystickGUID`"); // /usr/include/SDL3/SDL_oldnames.h:980:9
pub const SDL_JoystickGetGUIDFromString = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetGUIDFromString_renamed_SDL_GUIDFromString`"); // /usr/include/SDL3/SDL_oldnames.h:981:9
pub const SDL_JoystickGetHat = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetHat_renamed_SDL_GetJoystickHat`"); // /usr/include/SDL3/SDL_oldnames.h:982:9
pub const SDL_JoystickGetPlayerIndex = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetPlayerIndex_renamed_SDL_GetJoystickPlayerIndex`"); // /usr/include/SDL3/SDL_oldnames.h:983:9
pub const SDL_JoystickGetProduct = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetProduct_renamed_SDL_GetJoystickProduct`"); // /usr/include/SDL3/SDL_oldnames.h:984:9
pub const SDL_JoystickGetProductVersion = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetProductVersion_renamed_SDL_GetJoystickProductVersion`"); // /usr/include/SDL3/SDL_oldnames.h:985:9
pub const SDL_JoystickGetSerial = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetSerial_renamed_SDL_GetJoystickSerial`"); // /usr/include/SDL3/SDL_oldnames.h:986:9
pub const SDL_JoystickGetType = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetType_renamed_SDL_GetJoystickType`"); // /usr/include/SDL3/SDL_oldnames.h:987:9
pub const SDL_JoystickGetVendor = @compileError("unable to translate macro: undefined identifier `SDL_JoystickGetVendor_renamed_SDL_GetJoystickVendor`"); // /usr/include/SDL3/SDL_oldnames.h:988:9
pub const SDL_JoystickInstanceID = @compileError("unable to translate macro: undefined identifier `SDL_JoystickInstanceID_renamed_SDL_GetJoystickID`"); // /usr/include/SDL3/SDL_oldnames.h:989:9
pub const SDL_JoystickIsVirtual = @compileError("unable to translate macro: undefined identifier `SDL_JoystickIsVirtual_renamed_SDL_IsJoystickVirtual`"); // /usr/include/SDL3/SDL_oldnames.h:990:9
pub const SDL_JoystickName = @compileError("unable to translate macro: undefined identifier `SDL_JoystickName_renamed_SDL_GetJoystickName`"); // /usr/include/SDL3/SDL_oldnames.h:991:9
pub const SDL_JoystickNumAxes = @compileError("unable to translate macro: undefined identifier `SDL_JoystickNumAxes_renamed_SDL_GetNumJoystickAxes`"); // /usr/include/SDL3/SDL_oldnames.h:992:9
pub const SDL_JoystickNumBalls = @compileError("unable to translate macro: undefined identifier `SDL_JoystickNumBalls_renamed_SDL_GetNumJoystickBalls`"); // /usr/include/SDL3/SDL_oldnames.h:993:9
pub const SDL_JoystickNumButtons = @compileError("unable to translate macro: undefined identifier `SDL_JoystickNumButtons_renamed_SDL_GetNumJoystickButtons`"); // /usr/include/SDL3/SDL_oldnames.h:994:9
pub const SDL_JoystickNumHats = @compileError("unable to translate macro: undefined identifier `SDL_JoystickNumHats_renamed_SDL_GetNumJoystickHats`"); // /usr/include/SDL3/SDL_oldnames.h:995:9
pub const SDL_JoystickOpen = @compileError("unable to translate macro: undefined identifier `SDL_JoystickOpen_renamed_SDL_OpenJoystick`"); // /usr/include/SDL3/SDL_oldnames.h:996:9
pub const SDL_JoystickPath = @compileError("unable to translate macro: undefined identifier `SDL_JoystickPath_renamed_SDL_GetJoystickPath`"); // /usr/include/SDL3/SDL_oldnames.h:997:9
pub const SDL_JoystickRumble = @compileError("unable to translate macro: undefined identifier `SDL_JoystickRumble_renamed_SDL_RumbleJoystick`"); // /usr/include/SDL3/SDL_oldnames.h:998:9
pub const SDL_JoystickRumbleTriggers = @compileError("unable to translate macro: undefined identifier `SDL_JoystickRumbleTriggers_renamed_SDL_RumbleJoystickTriggers`"); // /usr/include/SDL3/SDL_oldnames.h:999:9
pub const SDL_JoystickSendEffect = @compileError("unable to translate macro: undefined identifier `SDL_JoystickSendEffect_renamed_SDL_SendJoystickEffect`"); // /usr/include/SDL3/SDL_oldnames.h:1000:9
pub const SDL_JoystickSetLED = @compileError("unable to translate macro: undefined identifier `SDL_JoystickSetLED_renamed_SDL_SetJoystickLED`"); // /usr/include/SDL3/SDL_oldnames.h:1001:9
pub const SDL_JoystickSetPlayerIndex = @compileError("unable to translate macro: undefined identifier `SDL_JoystickSetPlayerIndex_renamed_SDL_SetJoystickPlayerIndex`"); // /usr/include/SDL3/SDL_oldnames.h:1002:9
pub const SDL_JoystickSetVirtualAxis = @compileError("unable to translate macro: undefined identifier `SDL_JoystickSetVirtualAxis_renamed_SDL_SetJoystickVirtualAxis`"); // /usr/include/SDL3/SDL_oldnames.h:1003:9
pub const SDL_JoystickSetVirtualButton = @compileError("unable to translate macro: undefined identifier `SDL_JoystickSetVirtualButton_renamed_SDL_SetJoystickVirtualButton`"); // /usr/include/SDL3/SDL_oldnames.h:1004:9
pub const SDL_JoystickSetVirtualHat = @compileError("unable to translate macro: undefined identifier `SDL_JoystickSetVirtualHat_renamed_SDL_SetJoystickVirtualHat`"); // /usr/include/SDL3/SDL_oldnames.h:1005:9
pub const SDL_JoystickUpdate = @compileError("unable to translate macro: undefined identifier `SDL_JoystickUpdate_renamed_SDL_UpdateJoysticks`"); // /usr/include/SDL3/SDL_oldnames.h:1006:9
pub const SDL_NumJoysticks = @compileError("unable to translate macro: undefined identifier `SDL_NumJoysticks_deprecated_use_SDL_GetJoysticks`"); // /usr/include/SDL3/SDL_oldnames.h:1007:9
pub const SDL_IsScreenKeyboardShown = @compileError("unable to translate macro: undefined identifier `SDL_IsScreenKeyboardShown_renamed_SDL_ScreenKeyboardShown`"); // /usr/include/SDL3/SDL_oldnames.h:1010:9
pub const SDL_IsTextInputActive = @compileError("unable to translate macro: undefined identifier `SDL_IsTextInputActive_renamed_SDL_TextInputActive`"); // /usr/include/SDL3/SDL_oldnames.h:1011:9
pub const KMOD_ALT = @compileError("unable to translate macro: undefined identifier `KMOD_ALT_renamed_SDL_KMOD_ALT`"); // /usr/include/SDL3/SDL_oldnames.h:1014:9
pub const KMOD_CAPS = @compileError("unable to translate macro: undefined identifier `KMOD_CAPS_renamed_SDL_KMOD_CAPS`"); // /usr/include/SDL3/SDL_oldnames.h:1015:9
pub const KMOD_CTRL = @compileError("unable to translate macro: undefined identifier `KMOD_CTRL_renamed_SDL_KMOD_CTRL`"); // /usr/include/SDL3/SDL_oldnames.h:1016:9
pub const KMOD_GUI = @compileError("unable to translate macro: undefined identifier `KMOD_GUI_renamed_SDL_KMOD_GUI`"); // /usr/include/SDL3/SDL_oldnames.h:1017:9
pub const KMOD_LALT = @compileError("unable to translate macro: undefined identifier `KMOD_LALT_renamed_SDL_KMOD_LALT`"); // /usr/include/SDL3/SDL_oldnames.h:1018:9
pub const KMOD_LCTRL = @compileError("unable to translate macro: undefined identifier `KMOD_LCTRL_renamed_SDL_KMOD_LCTRL`"); // /usr/include/SDL3/SDL_oldnames.h:1019:9
pub const KMOD_LGUI = @compileError("unable to translate macro: undefined identifier `KMOD_LGUI_renamed_SDL_KMOD_LGUI`"); // /usr/include/SDL3/SDL_oldnames.h:1020:9
pub const KMOD_LSHIFT = @compileError("unable to translate macro: undefined identifier `KMOD_LSHIFT_renamed_SDL_KMOD_LSHIFT`"); // /usr/include/SDL3/SDL_oldnames.h:1021:9
pub const KMOD_MODE = @compileError("unable to translate macro: undefined identifier `KMOD_MODE_renamed_SDL_KMOD_MODE`"); // /usr/include/SDL3/SDL_oldnames.h:1022:9
pub const KMOD_NONE = @compileError("unable to translate macro: undefined identifier `KMOD_NONE_renamed_SDL_KMOD_NONE`"); // /usr/include/SDL3/SDL_oldnames.h:1023:9
pub const KMOD_NUM = @compileError("unable to translate macro: undefined identifier `KMOD_NUM_renamed_SDL_KMOD_NUM`"); // /usr/include/SDL3/SDL_oldnames.h:1024:9
pub const KMOD_RALT = @compileError("unable to translate macro: undefined identifier `KMOD_RALT_renamed_SDL_KMOD_RALT`"); // /usr/include/SDL3/SDL_oldnames.h:1025:9
pub const KMOD_RCTRL = @compileError("unable to translate macro: undefined identifier `KMOD_RCTRL_renamed_SDL_KMOD_RCTRL`"); // /usr/include/SDL3/SDL_oldnames.h:1026:9
pub const KMOD_RGUI = @compileError("unable to translate macro: undefined identifier `KMOD_RGUI_renamed_SDL_KMOD_RGUI`"); // /usr/include/SDL3/SDL_oldnames.h:1027:9
pub const KMOD_RSHIFT = @compileError("unable to translate macro: undefined identifier `KMOD_RSHIFT_renamed_SDL_KMOD_RSHIFT`"); // /usr/include/SDL3/SDL_oldnames.h:1028:9
pub const KMOD_SCROLL = @compileError("unable to translate macro: undefined identifier `KMOD_SCROLL_renamed_SDL_KMOD_SCROLL`"); // /usr/include/SDL3/SDL_oldnames.h:1029:9
pub const KMOD_SHIFT = @compileError("unable to translate macro: undefined identifier `KMOD_SHIFT_renamed_SDL_KMOD_SHIFT`"); // /usr/include/SDL3/SDL_oldnames.h:1030:9
pub const SDLK_AUDIOFASTFORWARD = @compileError("unable to translate macro: undefined identifier `SDLK_AUDIOFASTFORWARD_renamed_SDLK_MEDIA_FAST_FORWARD`"); // /usr/include/SDL3/SDL_oldnames.h:1031:9
pub const SDLK_AUDIOMUTE = @compileError("unable to translate macro: undefined identifier `SDLK_AUDIOMUTE_renamed_SDLK_MUTE`"); // /usr/include/SDL3/SDL_oldnames.h:1032:9
pub const SDLK_AUDIONEXT = @compileError("unable to translate macro: undefined identifier `SDLK_AUDIONEXT_renamed_SDLK_MEDIA_NEXT_TRACK`"); // /usr/include/SDL3/SDL_oldnames.h:1033:9
pub const SDLK_AUDIOPLAY = @compileError("unable to translate macro: undefined identifier `SDLK_AUDIOPLAY_renamed_SDLK_MEDIA_PLAY`"); // /usr/include/SDL3/SDL_oldnames.h:1034:9
pub const SDLK_AUDIOPREV = @compileError("unable to translate macro: undefined identifier `SDLK_AUDIOPREV_renamed_SDLK_MEDIA_PREVIOUS_TRACK`"); // /usr/include/SDL3/SDL_oldnames.h:1035:9
pub const SDLK_AUDIOREWIND = @compileError("unable to translate macro: undefined identifier `SDLK_AUDIOREWIND_renamed_SDLK_MEDIA_REWIND`"); // /usr/include/SDL3/SDL_oldnames.h:1036:9
pub const SDLK_AUDIOSTOP = @compileError("unable to translate macro: undefined identifier `SDLK_AUDIOSTOP_renamed_SDLK_MEDIA_STOP`"); // /usr/include/SDL3/SDL_oldnames.h:1037:9
pub const SDLK_BACKQUOTE = @compileError("unable to translate macro: undefined identifier `SDLK_BACKQUOTE_renamed_SDLK_GRAVE`"); // /usr/include/SDL3/SDL_oldnames.h:1038:9
pub const SDLK_EJECT = @compileError("unable to translate macro: undefined identifier `SDLK_EJECT_renamed_SDLK_MEDIA_EJECT`"); // /usr/include/SDL3/SDL_oldnames.h:1039:9
pub const SDLK_MEDIASELECT = @compileError("unable to translate macro: undefined identifier `SDLK_MEDIASELECT_renamed_SDLK_MEDIA_SELECT`"); // /usr/include/SDL3/SDL_oldnames.h:1040:9
pub const SDLK_QUOTE = @compileError("unable to translate macro: undefined identifier `SDLK_QUOTE_renamed_SDLK_APOSTROPHE`"); // /usr/include/SDL3/SDL_oldnames.h:1041:9
pub const SDLK_QUOTEDBL = @compileError("unable to translate macro: undefined identifier `SDLK_QUOTEDBL_renamed_SDLK_DBLAPOSTROPHE`"); // /usr/include/SDL3/SDL_oldnames.h:1042:9
pub const SDLK_a = @compileError("unable to translate macro: undefined identifier `SDLK_a_renamed_SDLK_A`"); // /usr/include/SDL3/SDL_oldnames.h:1043:9
pub const SDLK_b = @compileError("unable to translate macro: undefined identifier `SDLK_b_renamed_SDLK_B`"); // /usr/include/SDL3/SDL_oldnames.h:1044:9
pub const SDLK_c = @compileError("unable to translate macro: undefined identifier `SDLK_c_renamed_SDLK_C`"); // /usr/include/SDL3/SDL_oldnames.h:1045:9
pub const SDLK_d = @compileError("unable to translate macro: undefined identifier `SDLK_d_renamed_SDLK_D`"); // /usr/include/SDL3/SDL_oldnames.h:1046:9
pub const SDLK_e = @compileError("unable to translate macro: undefined identifier `SDLK_e_renamed_SDLK_E`"); // /usr/include/SDL3/SDL_oldnames.h:1047:9
pub const SDLK_f = @compileError("unable to translate macro: undefined identifier `SDLK_f_renamed_SDLK_F`"); // /usr/include/SDL3/SDL_oldnames.h:1048:9
pub const SDLK_g = @compileError("unable to translate macro: undefined identifier `SDLK_g_renamed_SDLK_G`"); // /usr/include/SDL3/SDL_oldnames.h:1049:9
pub const SDLK_h = @compileError("unable to translate macro: undefined identifier `SDLK_h_renamed_SDLK_H`"); // /usr/include/SDL3/SDL_oldnames.h:1050:9
pub const SDLK_i = @compileError("unable to translate macro: undefined identifier `SDLK_i_renamed_SDLK_I`"); // /usr/include/SDL3/SDL_oldnames.h:1051:9
pub const SDLK_j = @compileError("unable to translate macro: undefined identifier `SDLK_j_renamed_SDLK_J`"); // /usr/include/SDL3/SDL_oldnames.h:1052:9
pub const SDLK_k = @compileError("unable to translate macro: undefined identifier `SDLK_k_renamed_SDLK_K`"); // /usr/include/SDL3/SDL_oldnames.h:1053:9
pub const SDLK_l = @compileError("unable to translate macro: undefined identifier `SDLK_l_renamed_SDLK_L`"); // /usr/include/SDL3/SDL_oldnames.h:1054:9
pub const SDLK_m = @compileError("unable to translate macro: undefined identifier `SDLK_m_renamed_SDLK_M`"); // /usr/include/SDL3/SDL_oldnames.h:1055:9
pub const SDLK_n = @compileError("unable to translate macro: undefined identifier `SDLK_n_renamed_SDLK_N`"); // /usr/include/SDL3/SDL_oldnames.h:1056:9
pub const SDLK_o = @compileError("unable to translate macro: undefined identifier `SDLK_o_renamed_SDLK_O`"); // /usr/include/SDL3/SDL_oldnames.h:1057:9
pub const SDLK_p = @compileError("unable to translate macro: undefined identifier `SDLK_p_renamed_SDLK_P`"); // /usr/include/SDL3/SDL_oldnames.h:1058:9
pub const SDLK_q = @compileError("unable to translate macro: undefined identifier `SDLK_q_renamed_SDLK_Q`"); // /usr/include/SDL3/SDL_oldnames.h:1059:9
pub const SDLK_r = @compileError("unable to translate macro: undefined identifier `SDLK_r_renamed_SDLK_R`"); // /usr/include/SDL3/SDL_oldnames.h:1060:9
pub const SDLK_s = @compileError("unable to translate macro: undefined identifier `SDLK_s_renamed_SDLK_S`"); // /usr/include/SDL3/SDL_oldnames.h:1061:9
pub const SDLK_t = @compileError("unable to translate macro: undefined identifier `SDLK_t_renamed_SDLK_T`"); // /usr/include/SDL3/SDL_oldnames.h:1062:9
pub const SDLK_u = @compileError("unable to translate macro: undefined identifier `SDLK_u_renamed_SDLK_U`"); // /usr/include/SDL3/SDL_oldnames.h:1063:9
pub const SDLK_v = @compileError("unable to translate macro: undefined identifier `SDLK_v_renamed_SDLK_V`"); // /usr/include/SDL3/SDL_oldnames.h:1064:9
pub const SDLK_w = @compileError("unable to translate macro: undefined identifier `SDLK_w_renamed_SDLK_W`"); // /usr/include/SDL3/SDL_oldnames.h:1065:9
pub const SDLK_x = @compileError("unable to translate macro: undefined identifier `SDLK_x_renamed_SDLK_X`"); // /usr/include/SDL3/SDL_oldnames.h:1066:9
pub const SDLK_y = @compileError("unable to translate macro: undefined identifier `SDLK_y_renamed_SDLK_Y`"); // /usr/include/SDL3/SDL_oldnames.h:1067:9
pub const SDLK_z = @compileError("unable to translate macro: undefined identifier `SDLK_z_renamed_SDLK_Z`"); // /usr/include/SDL3/SDL_oldnames.h:1068:9
pub const SDL_LogGetOutputFunction = @compileError("unable to translate macro: undefined identifier `SDL_LogGetOutputFunction_renamed_SDL_GetLogOutputFunction`"); // /usr/include/SDL3/SDL_oldnames.h:1071:9
pub const SDL_LogGetPriority = @compileError("unable to translate macro: undefined identifier `SDL_LogGetPriority_renamed_SDL_GetLogPriority`"); // /usr/include/SDL3/SDL_oldnames.h:1072:9
pub const SDL_LogResetPriorities = @compileError("unable to translate macro: undefined identifier `SDL_LogResetPriorities_renamed_SDL_ResetLogPriorities`"); // /usr/include/SDL3/SDL_oldnames.h:1073:9
pub const SDL_LogSetAllPriority = @compileError("unable to translate macro: undefined identifier `SDL_LogSetAllPriority_renamed_SDL_SetLogPriorities`"); // /usr/include/SDL3/SDL_oldnames.h:1074:9
pub const SDL_LogSetOutputFunction = @compileError("unable to translate macro: undefined identifier `SDL_LogSetOutputFunction_renamed_SDL_SetLogOutputFunction`"); // /usr/include/SDL3/SDL_oldnames.h:1075:9
pub const SDL_LogSetPriority = @compileError("unable to translate macro: undefined identifier `SDL_LogSetPriority_renamed_SDL_SetLogPriority`"); // /usr/include/SDL3/SDL_oldnames.h:1076:9
pub const SDL_NUM_LOG_PRIORITIES = @compileError("unable to translate macro: undefined identifier `SDL_NUM_LOG_PRIORITIES_renamed_SDL_LOG_PRIORITY_COUNT`"); // /usr/include/SDL3/SDL_oldnames.h:1077:9
pub const SDL_MESSAGEBOX_COLOR_MAX = @compileError("unable to translate macro: undefined identifier `SDL_MESSAGEBOX_COLOR_MAX_renamed_SDL_MESSAGEBOX_COLOR_COUNT`"); // /usr/include/SDL3/SDL_oldnames.h:1080:9
pub const SDL_BUTTON = @compileError("unable to translate macro: undefined identifier `SDL_BUTTON_renamed_SDL_BUTTON_MASK`"); // /usr/include/SDL3/SDL_oldnames.h:1083:9
pub const SDL_FreeCursor = @compileError("unable to translate macro: undefined identifier `SDL_FreeCursor_renamed_SDL_DestroyCursor`"); // /usr/include/SDL3/SDL_oldnames.h:1084:9
pub const SDL_NUM_SYSTEM_CURSORS = @compileError("unable to translate macro: undefined identifier `SDL_NUM_SYSTEM_CURSORS_renamed_SDL_SYSTEM_CURSOR_COUNT`"); // /usr/include/SDL3/SDL_oldnames.h:1085:9
pub const SDL_SYSTEM_CURSOR_ARROW = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_ARROW_renamed_SDL_SYSTEM_CURSOR_DEFAULT`"); // /usr/include/SDL3/SDL_oldnames.h:1086:9
pub const SDL_SYSTEM_CURSOR_HAND = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_HAND_renamed_SDL_SYSTEM_CURSOR_POINTER`"); // /usr/include/SDL3/SDL_oldnames.h:1087:9
pub const SDL_SYSTEM_CURSOR_IBEAM = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_IBEAM_renamed_SDL_SYSTEM_CURSOR_TEXT`"); // /usr/include/SDL3/SDL_oldnames.h:1088:9
pub const SDL_SYSTEM_CURSOR_NO = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_NO_renamed_SDL_SYSTEM_CURSOR_NOT_ALLOWED`"); // /usr/include/SDL3/SDL_oldnames.h:1089:9
pub const SDL_SYSTEM_CURSOR_SIZEALL = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_SIZEALL_renamed_SDL_SYSTEM_CURSOR_MOVE`"); // /usr/include/SDL3/SDL_oldnames.h:1090:9
pub const SDL_SYSTEM_CURSOR_SIZENESW = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_SIZENESW_renamed_SDL_SYSTEM_CURSOR_NESW_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1091:9
pub const SDL_SYSTEM_CURSOR_SIZENS = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_SIZENS_renamed_SDL_SYSTEM_CURSOR_NS_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1092:9
pub const SDL_SYSTEM_CURSOR_SIZENWSE = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_SIZENWSE_renamed_SDL_SYSTEM_CURSOR_NWSE_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1093:9
pub const SDL_SYSTEM_CURSOR_SIZEWE = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_SIZEWE_renamed_SDL_SYSTEM_CURSOR_EW_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1094:9
pub const SDL_SYSTEM_CURSOR_WAITARROW = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WAITARROW_renamed_SDL_SYSTEM_CURSOR_PROGRESS`"); // /usr/include/SDL3/SDL_oldnames.h:1095:9
pub const SDL_SYSTEM_CURSOR_WINDOW_BOTTOM = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_BOTTOM_renamed_SDL_SYSTEM_CURSOR_S_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1096:9
pub const SDL_SYSTEM_CURSOR_WINDOW_BOTTOMLEFT = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_BOTTOMLEFT_renamed_SDL_SYSTEM_CURSOR_SW_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1097:9
pub const SDL_SYSTEM_CURSOR_WINDOW_BOTTOMRIGHT = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_BOTTOMRIGHT_renamed_SDL_SYSTEM_CURSOR_SE_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1098:9
pub const SDL_SYSTEM_CURSOR_WINDOW_LEFT = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_LEFT_renamed_SDL_SYSTEM_CURSOR_W_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1099:9
pub const SDL_SYSTEM_CURSOR_WINDOW_RIGHT = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_RIGHT_renamed_SDL_SYSTEM_CURSOR_E_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1100:9
pub const SDL_SYSTEM_CURSOR_WINDOW_TOP = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_TOP_renamed_SDL_SYSTEM_CURSOR_N_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1101:9
pub const SDL_SYSTEM_CURSOR_WINDOW_TOPLEFT = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_TOPLEFT_renamed_SDL_SYSTEM_CURSOR_NW_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1102:9
pub const SDL_SYSTEM_CURSOR_WINDOW_TOPRIGHT = @compileError("unable to translate macro: undefined identifier `SDL_SYSTEM_CURSOR_WINDOW_TOPRIGHT_renamed_SDL_SYSTEM_CURSOR_NE_RESIZE`"); // /usr/include/SDL3/SDL_oldnames.h:1103:9
pub const SDL_CondBroadcast = @compileError("unable to translate macro: undefined identifier `SDL_CondBroadcast_renamed_SDL_BroadcastCondition`"); // /usr/include/SDL3/SDL_oldnames.h:1106:9
pub const SDL_CondSignal = @compileError("unable to translate macro: undefined identifier `SDL_CondSignal_renamed_SDL_SignalCondition`"); // /usr/include/SDL3/SDL_oldnames.h:1107:9
pub const SDL_CondWait = @compileError("unable to translate macro: undefined identifier `SDL_CondWait_renamed_SDL_WaitCondition`"); // /usr/include/SDL3/SDL_oldnames.h:1108:9
pub const SDL_CondWaitTimeout = @compileError("unable to translate macro: undefined identifier `SDL_CondWaitTimeout_renamed_SDL_WaitConditionTimeout`"); // /usr/include/SDL3/SDL_oldnames.h:1109:9
pub const SDL_CreateCond = @compileError("unable to translate macro: undefined identifier `SDL_CreateCond_renamed_SDL_CreateCondition`"); // /usr/include/SDL3/SDL_oldnames.h:1110:9
pub const SDL_DestroyCond = @compileError("unable to translate macro: undefined identifier `SDL_DestroyCond_renamed_SDL_DestroyCondition`"); // /usr/include/SDL3/SDL_oldnames.h:1111:9
pub const SDL_SemPost = @compileError("unable to translate macro: undefined identifier `SDL_SemPost_renamed_SDL_SignalSemaphore`"); // /usr/include/SDL3/SDL_oldnames.h:1112:9
pub const SDL_SemTryWait = @compileError("unable to translate macro: undefined identifier `SDL_SemTryWait_renamed_SDL_TryWaitSemaphore`"); // /usr/include/SDL3/SDL_oldnames.h:1113:9
pub const SDL_SemValue = @compileError("unable to translate macro: undefined identifier `SDL_SemValue_renamed_SDL_GetSemaphoreValue`"); // /usr/include/SDL3/SDL_oldnames.h:1114:9
pub const SDL_SemWait = @compileError("unable to translate macro: undefined identifier `SDL_SemWait_renamed_SDL_WaitSemaphore`"); // /usr/include/SDL3/SDL_oldnames.h:1115:9
pub const SDL_SemWaitTimeout = @compileError("unable to translate macro: undefined identifier `SDL_SemWaitTimeout_renamed_SDL_WaitSemaphoreTimeout`"); // /usr/include/SDL3/SDL_oldnames.h:1116:9
pub const SDL_cond = @compileError("unable to translate macro: undefined identifier `SDL_cond_renamed_SDL_Condition`"); // /usr/include/SDL3/SDL_oldnames.h:1119:9
pub const SDL_mutex = @compileError("unable to translate macro: undefined identifier `SDL_mutex_renamed_SDL_Mutex`"); // /usr/include/SDL3/SDL_oldnames.h:1120:9
pub const SDL_sem = @compileError("unable to translate macro: undefined identifier `SDL_sem_renamed_SDL_Semaphore`"); // /usr/include/SDL3/SDL_oldnames.h:1121:9
pub const SDL_AllocFormat = @compileError("unable to translate macro: undefined identifier `SDL_AllocFormat_renamed_SDL_GetPixelFormatDetails`"); // /usr/include/SDL3/SDL_oldnames.h:1124:9
pub const SDL_AllocPalette = @compileError("unable to translate macro: undefined identifier `SDL_AllocPalette_renamed_SDL_CreatePalette`"); // /usr/include/SDL3/SDL_oldnames.h:1125:9
pub const SDL_Colour = @compileError("unable to translate macro: undefined identifier `SDL_Colour_renamed_SDL_Color`"); // /usr/include/SDL3/SDL_oldnames.h:1126:9
pub const SDL_FreePalette = @compileError("unable to translate macro: undefined identifier `SDL_FreePalette_renamed_SDL_DestroyPalette`"); // /usr/include/SDL3/SDL_oldnames.h:1127:9
pub const SDL_MasksToPixelFormatEnum = @compileError("unable to translate macro: undefined identifier `SDL_MasksToPixelFormatEnum_renamed_SDL_GetPixelFormatForMasks`"); // /usr/include/SDL3/SDL_oldnames.h:1128:9
pub const SDL_PIXELFORMAT_BGR444 = @compileError("unable to translate macro: undefined identifier `SDL_PIXELFORMAT_BGR444_renamed_SDL_PIXELFORMAT_XBGR4444`"); // /usr/include/SDL3/SDL_oldnames.h:1129:9
pub const SDL_PIXELFORMAT_BGR555 = @compileError("unable to translate macro: undefined identifier `SDL_PIXELFORMAT_BGR555_renamed_SDL_PIXELFORMAT_XBGR1555`"); // /usr/include/SDL3/SDL_oldnames.h:1130:9
pub const SDL_PIXELFORMAT_BGR888 = @compileError("unable to translate macro: undefined identifier `SDL_PIXELFORMAT_BGR888_renamed_SDL_PIXELFORMAT_XBGR8888`"); // /usr/include/SDL3/SDL_oldnames.h:1131:9
pub const SDL_PIXELFORMAT_RGB444 = @compileError("unable to translate macro: undefined identifier `SDL_PIXELFORMAT_RGB444_renamed_SDL_PIXELFORMAT_XRGB4444`"); // /usr/include/SDL3/SDL_oldnames.h:1132:9
pub const SDL_PIXELFORMAT_RGB555 = @compileError("unable to translate macro: undefined identifier `SDL_PIXELFORMAT_RGB555_renamed_SDL_PIXELFORMAT_XRGB1555`"); // /usr/include/SDL3/SDL_oldnames.h:1133:9
pub const SDL_PIXELFORMAT_RGB888 = @compileError("unable to translate macro: undefined identifier `SDL_PIXELFORMAT_RGB888_renamed_SDL_PIXELFORMAT_XRGB8888`"); // /usr/include/SDL3/SDL_oldnames.h:1134:9
pub const SDL_PixelFormatEnumToMasks = @compileError("unable to translate macro: undefined identifier `SDL_PixelFormatEnumToMasks_renamed_SDL_GetMasksForPixelFormat`"); // /usr/include/SDL3/SDL_oldnames.h:1135:9
pub const SDL_EncloseFPoints = @compileError("unable to translate macro: undefined identifier `SDL_EncloseFPoints_renamed_SDL_GetRectEnclosingPointsFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1138:9
pub const SDL_EnclosePoints = @compileError("unable to translate macro: undefined identifier `SDL_EnclosePoints_renamed_SDL_GetRectEnclosingPoints`"); // /usr/include/SDL3/SDL_oldnames.h:1139:9
pub const SDL_FRectEmpty = @compileError("unable to translate macro: undefined identifier `SDL_FRectEmpty_renamed_SDL_RectEmptyFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1140:9
pub const SDL_FRectEquals = @compileError("unable to translate macro: undefined identifier `SDL_FRectEquals_renamed_SDL_RectsEqualFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1141:9
pub const SDL_FRectEqualsEpsilon = @compileError("unable to translate macro: undefined identifier `SDL_FRectEqualsEpsilon_renamed_SDL_RectsEqualEpsilon`"); // /usr/include/SDL3/SDL_oldnames.h:1142:9
pub const SDL_HasIntersection = @compileError("unable to translate macro: undefined identifier `SDL_HasIntersection_renamed_SDL_HasRectIntersection`"); // /usr/include/SDL3/SDL_oldnames.h:1143:9
pub const SDL_HasIntersectionF = @compileError("unable to translate macro: undefined identifier `SDL_HasIntersectionF_renamed_SDL_HasRectIntersectionFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1144:9
pub const SDL_IntersectFRect = @compileError("unable to translate macro: undefined identifier `SDL_IntersectFRect_renamed_SDL_GetRectIntersectionFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1145:9
pub const SDL_IntersectFRectAndLine = @compileError("unable to translate macro: undefined identifier `SDL_IntersectFRectAndLine_renamed_SDL_GetRectAndLineIntersectionFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1146:9
pub const SDL_IntersectRect = @compileError("unable to translate macro: undefined identifier `SDL_IntersectRect_renamed_SDL_GetRectIntersection`"); // /usr/include/SDL3/SDL_oldnames.h:1147:9
pub const SDL_IntersectRectAndLine = @compileError("unable to translate macro: undefined identifier `SDL_IntersectRectAndLine_renamed_SDL_GetRectAndLineIntersection`"); // /usr/include/SDL3/SDL_oldnames.h:1148:9
pub const SDL_PointInFRect = @compileError("unable to translate macro: undefined identifier `SDL_PointInFRect_renamed_SDL_PointInRectFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1149:9
pub const SDL_RectEquals = @compileError("unable to translate macro: undefined identifier `SDL_RectEquals_renamed_SDL_RectsEqual`"); // /usr/include/SDL3/SDL_oldnames.h:1150:9
pub const SDL_UnionFRect = @compileError("unable to translate macro: undefined identifier `SDL_UnionFRect_renamed_SDL_GetRectUnionFloat`"); // /usr/include/SDL3/SDL_oldnames.h:1151:9
pub const SDL_UnionRect = @compileError("unable to translate macro: undefined identifier `SDL_UnionRect_renamed_SDL_GetRectUnion`"); // /usr/include/SDL3/SDL_oldnames.h:1152:9
pub const SDL_GetRendererOutputSize = @compileError("unable to translate macro: undefined identifier `SDL_GetRendererOutputSize_renamed_SDL_GetCurrentRenderOutputSize`"); // /usr/include/SDL3/SDL_oldnames.h:1155:9
pub const SDL_RENDERER_ACCELERATED = @compileError("unable to translate macro: undefined identifier `SDL_RENDERER_ACCELERATED_deprecated_remove_this_line`"); // /usr/include/SDL3/SDL_oldnames.h:1156:9
pub const SDL_RENDERER_PRESENTVSYNC = @compileError("unable to translate macro: undefined identifier `SDL_RENDERER_PRESENTVSYNC_deprecated_use_SDL_SetRenderVSync`"); // /usr/include/SDL3/SDL_oldnames.h:1157:9
pub const SDL_RenderCopy = @compileError("unable to translate macro: undefined identifier `SDL_RenderCopy_renamed_SDL_RenderTexture`"); // /usr/include/SDL3/SDL_oldnames.h:1158:9
pub const SDL_RenderCopyEx = @compileError("unable to translate macro: undefined identifier `SDL_RenderCopyEx_renamed_SDL_RenderTextureRotated`"); // /usr/include/SDL3/SDL_oldnames.h:1159:9
pub const SDL_RenderCopyExF = @compileError("unable to translate macro: undefined identifier `SDL_RenderCopyExF_renamed_SDL_RenderTextureRotated`"); // /usr/include/SDL3/SDL_oldnames.h:1160:9
pub const SDL_RenderCopyF = @compileError("unable to translate macro: undefined identifier `SDL_RenderCopyF_renamed_SDL_RenderTexture`"); // /usr/include/SDL3/SDL_oldnames.h:1161:9
pub const SDL_RenderDrawLine = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawLine_renamed_SDL_RenderLine`"); // /usr/include/SDL3/SDL_oldnames.h:1162:9
pub const SDL_RenderDrawLineF = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawLineF_renamed_SDL_RenderLine`"); // /usr/include/SDL3/SDL_oldnames.h:1163:9
pub const SDL_RenderDrawLines = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawLines_renamed_SDL_RenderLines`"); // /usr/include/SDL3/SDL_oldnames.h:1164:9
pub const SDL_RenderDrawLinesF = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawLinesF_renamed_SDL_RenderLines`"); // /usr/include/SDL3/SDL_oldnames.h:1165:9
pub const SDL_RenderDrawPoint = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawPoint_renamed_SDL_RenderPoint`"); // /usr/include/SDL3/SDL_oldnames.h:1166:9
pub const SDL_RenderDrawPointF = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawPointF_renamed_SDL_RenderPoint`"); // /usr/include/SDL3/SDL_oldnames.h:1167:9
pub const SDL_RenderDrawPoints = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawPoints_renamed_SDL_RenderPoints`"); // /usr/include/SDL3/SDL_oldnames.h:1168:9
pub const SDL_RenderDrawPointsF = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawPointsF_renamed_SDL_RenderPoints`"); // /usr/include/SDL3/SDL_oldnames.h:1169:9
pub const SDL_RenderDrawRect = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawRect_renamed_SDL_RenderRect`"); // /usr/include/SDL3/SDL_oldnames.h:1170:9
pub const SDL_RenderDrawRectF = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawRectF_renamed_SDL_RenderRect`"); // /usr/include/SDL3/SDL_oldnames.h:1171:9
pub const SDL_RenderDrawRects = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawRects_renamed_SDL_RenderRects`"); // /usr/include/SDL3/SDL_oldnames.h:1172:9
pub const SDL_RenderDrawRectsF = @compileError("unable to translate macro: undefined identifier `SDL_RenderDrawRectsF_renamed_SDL_RenderRects`"); // /usr/include/SDL3/SDL_oldnames.h:1173:9
pub const SDL_RenderFillRectF = @compileError("unable to translate macro: undefined identifier `SDL_RenderFillRectF_renamed_SDL_RenderFillRect`"); // /usr/include/SDL3/SDL_oldnames.h:1174:9
pub const SDL_RenderFillRectsF = @compileError("unable to translate macro: undefined identifier `SDL_RenderFillRectsF_renamed_SDL_RenderFillRects`"); // /usr/include/SDL3/SDL_oldnames.h:1175:9
pub const SDL_RendererFlip = @compileError("unable to translate macro: undefined identifier `SDL_RendererFlip_renamed_SDL_FlipMode`"); // /usr/include/SDL3/SDL_oldnames.h:1176:9
pub const SDL_RenderFlush = @compileError("unable to translate macro: undefined identifier `SDL_RenderFlush_renamed_SDL_FlushRenderer`"); // /usr/include/SDL3/SDL_oldnames.h:1177:9
pub const SDL_RenderGetClipRect = @compileError("unable to translate macro: undefined identifier `SDL_RenderGetClipRect_renamed_SDL_GetRenderClipRect`"); // /usr/include/SDL3/SDL_oldnames.h:1178:9
pub const SDL_RenderGetLogicalSize = @compileError("unable to translate macro: undefined identifier `SDL_RenderGetLogicalSize_renamed_SDL_GetRenderLogicalPresentation`"); // /usr/include/SDL3/SDL_oldnames.h:1179:9
pub const SDL_RenderGetMetalCommandEncoder = @compileError("unable to translate macro: undefined identifier `SDL_RenderGetMetalCommandEncoder_renamed_SDL_GetRenderMetalCommandEncoder`"); // /usr/include/SDL3/SDL_oldnames.h:1180:9
pub const SDL_RenderGetMetalLayer = @compileError("unable to translate macro: undefined identifier `SDL_RenderGetMetalLayer_renamed_SDL_GetRenderMetalLayer`"); // /usr/include/SDL3/SDL_oldnames.h:1181:9
pub const SDL_RenderGetScale = @compileError("unable to translate macro: undefined identifier `SDL_RenderGetScale_renamed_SDL_GetRenderScale`"); // /usr/include/SDL3/SDL_oldnames.h:1182:9
pub const SDL_RenderGetViewport = @compileError("unable to translate macro: undefined identifier `SDL_RenderGetViewport_renamed_SDL_GetRenderViewport`"); // /usr/include/SDL3/SDL_oldnames.h:1183:9
pub const SDL_RenderGetWindow = @compileError("unable to translate macro: undefined identifier `SDL_RenderGetWindow_renamed_SDL_GetRenderWindow`"); // /usr/include/SDL3/SDL_oldnames.h:1184:9
pub const SDL_RenderIsClipEnabled = @compileError("unable to translate macro: undefined identifier `SDL_RenderIsClipEnabled_renamed_SDL_RenderClipEnabled`"); // /usr/include/SDL3/SDL_oldnames.h:1185:9
pub const SDL_RenderLogicalToWindow = @compileError("unable to translate macro: undefined identifier `SDL_RenderLogicalToWindow_renamed_SDL_RenderCoordinatesToWindow`"); // /usr/include/SDL3/SDL_oldnames.h:1186:9
pub const SDL_RenderSetClipRect = @compileError("unable to translate macro: undefined identifier `SDL_RenderSetClipRect_renamed_SDL_SetRenderClipRect`"); // /usr/include/SDL3/SDL_oldnames.h:1187:9
pub const SDL_RenderSetLogicalSize = @compileError("unable to translate macro: undefined identifier `SDL_RenderSetLogicalSize_renamed_SDL_SetRenderLogicalPresentation`"); // /usr/include/SDL3/SDL_oldnames.h:1188:9
pub const SDL_RenderSetScale = @compileError("unable to translate macro: undefined identifier `SDL_RenderSetScale_renamed_SDL_SetRenderScale`"); // /usr/include/SDL3/SDL_oldnames.h:1189:9
pub const SDL_RenderSetVSync = @compileError("unable to translate macro: undefined identifier `SDL_RenderSetVSync_renamed_SDL_SetRenderVSync`"); // /usr/include/SDL3/SDL_oldnames.h:1190:9
pub const SDL_RenderSetViewport = @compileError("unable to translate macro: undefined identifier `SDL_RenderSetViewport_renamed_SDL_SetRenderViewport`"); // /usr/include/SDL3/SDL_oldnames.h:1191:9
pub const SDL_RenderWindowToLogical = @compileError("unable to translate macro: undefined identifier `SDL_RenderWindowToLogical_renamed_SDL_RenderCoordinatesFromWindow`"); // /usr/include/SDL3/SDL_oldnames.h:1192:9
pub const SDL_ScaleModeLinear = @compileError("unable to translate macro: undefined identifier `SDL_ScaleModeLinear_renamed_SDL_SCALEMODE_LINEAR`"); // /usr/include/SDL3/SDL_oldnames.h:1193:9
pub const SDL_ScaleModeNearest = @compileError("unable to translate macro: undefined identifier `SDL_ScaleModeNearest_renamed_SDL_SCALEMODE_NEAREST`"); // /usr/include/SDL3/SDL_oldnames.h:1194:9
pub const RW_SEEK_CUR = @compileError("unable to translate macro: undefined identifier `RW_SEEK_CUR_renamed_SDL_IO_SEEK_CUR`"); // /usr/include/SDL3/SDL_oldnames.h:1197:9
pub const RW_SEEK_END = @compileError("unable to translate macro: undefined identifier `RW_SEEK_END_renamed_SDL_IO_SEEK_END`"); // /usr/include/SDL3/SDL_oldnames.h:1198:9
pub const RW_SEEK_SET = @compileError("unable to translate macro: undefined identifier `RW_SEEK_SET_renamed_SDL_IO_SEEK_SET`"); // /usr/include/SDL3/SDL_oldnames.h:1199:9
pub const SDL_RWFromConstMem = @compileError("unable to translate macro: undefined identifier `SDL_RWFromConstMem_renamed_SDL_IOFromConstMem`"); // /usr/include/SDL3/SDL_oldnames.h:1200:9
pub const SDL_RWFromFile = @compileError("unable to translate macro: undefined identifier `SDL_RWFromFile_renamed_SDL_IOFromFile`"); // /usr/include/SDL3/SDL_oldnames.h:1201:9
pub const SDL_RWFromMem = @compileError("unable to translate macro: undefined identifier `SDL_RWFromMem_renamed_SDL_IOFromMem`"); // /usr/include/SDL3/SDL_oldnames.h:1202:9
pub const SDL_RWclose = @compileError("unable to translate macro: undefined identifier `SDL_RWclose_renamed_SDL_CloseIO`"); // /usr/include/SDL3/SDL_oldnames.h:1203:9
pub const SDL_RWops = @compileError("unable to translate macro: undefined identifier `SDL_RWops_renamed_SDL_IOStream`"); // /usr/include/SDL3/SDL_oldnames.h:1204:9
pub const SDL_RWread = @compileError("unable to translate macro: undefined identifier `SDL_RWread_renamed_SDL_ReadIO`"); // /usr/include/SDL3/SDL_oldnames.h:1205:9
pub const SDL_RWseek = @compileError("unable to translate macro: undefined identifier `SDL_RWseek_renamed_SDL_SeekIO`"); // /usr/include/SDL3/SDL_oldnames.h:1206:9
pub const SDL_RWsize = @compileError("unable to translate macro: undefined identifier `SDL_RWsize_renamed_SDL_GetIOSize`"); // /usr/include/SDL3/SDL_oldnames.h:1207:9
pub const SDL_RWtell = @compileError("unable to translate macro: undefined identifier `SDL_RWtell_renamed_SDL_TellIO`"); // /usr/include/SDL3/SDL_oldnames.h:1208:9
pub const SDL_RWwrite = @compileError("unable to translate macro: undefined identifier `SDL_RWwrite_renamed_SDL_WriteIO`"); // /usr/include/SDL3/SDL_oldnames.h:1209:9
pub const SDL_ReadBE16 = @compileError("unable to translate macro: undefined identifier `SDL_ReadBE16_renamed_SDL_ReadU16BE`"); // /usr/include/SDL3/SDL_oldnames.h:1210:9
pub const SDL_ReadBE32 = @compileError("unable to translate macro: undefined identifier `SDL_ReadBE32_renamed_SDL_ReadU32BE`"); // /usr/include/SDL3/SDL_oldnames.h:1211:9
pub const SDL_ReadBE64 = @compileError("unable to translate macro: undefined identifier `SDL_ReadBE64_renamed_SDL_ReadU64BE`"); // /usr/include/SDL3/SDL_oldnames.h:1212:9
pub const SDL_ReadLE16 = @compileError("unable to translate macro: undefined identifier `SDL_ReadLE16_renamed_SDL_ReadU16LE`"); // /usr/include/SDL3/SDL_oldnames.h:1213:9
pub const SDL_ReadLE32 = @compileError("unable to translate macro: undefined identifier `SDL_ReadLE32_renamed_SDL_ReadU32LE`"); // /usr/include/SDL3/SDL_oldnames.h:1214:9
pub const SDL_ReadLE64 = @compileError("unable to translate macro: undefined identifier `SDL_ReadLE64_renamed_SDL_ReadU64LE`"); // /usr/include/SDL3/SDL_oldnames.h:1215:9
pub const SDL_WriteBE16 = @compileError("unable to translate macro: undefined identifier `SDL_WriteBE16_renamed_SDL_WriteU16BE`"); // /usr/include/SDL3/SDL_oldnames.h:1216:9
pub const SDL_WriteBE32 = @compileError("unable to translate macro: undefined identifier `SDL_WriteBE32_renamed_SDL_WriteU32BE`"); // /usr/include/SDL3/SDL_oldnames.h:1217:9
pub const SDL_WriteBE64 = @compileError("unable to translate macro: undefined identifier `SDL_WriteBE64_renamed_SDL_WriteU64BE`"); // /usr/include/SDL3/SDL_oldnames.h:1218:9
pub const SDL_WriteLE16 = @compileError("unable to translate macro: undefined identifier `SDL_WriteLE16_renamed_SDL_WriteU16LE`"); // /usr/include/SDL3/SDL_oldnames.h:1219:9
pub const SDL_WriteLE32 = @compileError("unable to translate macro: undefined identifier `SDL_WriteLE32_renamed_SDL_WriteU32LE`"); // /usr/include/SDL3/SDL_oldnames.h:1220:9
pub const SDL_WriteLE64 = @compileError("unable to translate macro: undefined identifier `SDL_WriteLE64_renamed_SDL_WriteU64LE`"); // /usr/include/SDL3/SDL_oldnames.h:1221:9
pub const SDL_NUM_SCANCODES = @compileError("unable to translate macro: undefined identifier `SDL_NUM_SCANCODES_renamed_SDL_SCANCODE_COUNT`"); // /usr/include/SDL3/SDL_oldnames.h:1224:9
pub const SDL_SCANCODE_AUDIOFASTFORWARD = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_AUDIOFASTFORWARD_renamed_SDL_SCANCODE_MEDIA_FAST_FORWARD`"); // /usr/include/SDL3/SDL_oldnames.h:1225:9
pub const SDL_SCANCODE_AUDIOMUTE = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_AUDIOMUTE_renamed_SDL_SCANCODE_MUTE`"); // /usr/include/SDL3/SDL_oldnames.h:1226:9
pub const SDL_SCANCODE_AUDIONEXT = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_AUDIONEXT_renamed_SDL_SCANCODE_MEDIA_NEXT_TRACK`"); // /usr/include/SDL3/SDL_oldnames.h:1227:9
pub const SDL_SCANCODE_AUDIOPLAY = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_AUDIOPLAY_renamed_SDL_SCANCODE_MEDIA_PLAY`"); // /usr/include/SDL3/SDL_oldnames.h:1228:9
pub const SDL_SCANCODE_AUDIOPREV = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_AUDIOPREV_renamed_SDL_SCANCODE_MEDIA_PREVIOUS_TRACK`"); // /usr/include/SDL3/SDL_oldnames.h:1229:9
pub const SDL_SCANCODE_AUDIOREWIND = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_AUDIOREWIND_renamed_SDL_SCANCODE_MEDIA_REWIND`"); // /usr/include/SDL3/SDL_oldnames.h:1230:9
pub const SDL_SCANCODE_AUDIOSTOP = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_AUDIOSTOP_renamed_SDL_SCANCODE_MEDIA_STOP`"); // /usr/include/SDL3/SDL_oldnames.h:1231:9
pub const SDL_SCANCODE_EJECT = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_EJECT_renamed_SDL_SCANCODE_MEDIA_EJECT`"); // /usr/include/SDL3/SDL_oldnames.h:1232:9
pub const SDL_SCANCODE_MEDIASELECT = @compileError("unable to translate macro: undefined identifier `SDL_SCANCODE_MEDIASELECT_renamed_SDL_SCANCODE_MEDIA_SELECT`"); // /usr/include/SDL3/SDL_oldnames.h:1233:9
pub const SDL_SensorClose = @compileError("unable to translate macro: undefined identifier `SDL_SensorClose_renamed_SDL_CloseSensor`"); // /usr/include/SDL3/SDL_oldnames.h:1236:9
pub const SDL_SensorFromInstanceID = @compileError("unable to translate macro: undefined identifier `SDL_SensorFromInstanceID_renamed_SDL_GetSensorFromID`"); // /usr/include/SDL3/SDL_oldnames.h:1237:9
pub const SDL_SensorGetData = @compileError("unable to translate macro: undefined identifier `SDL_SensorGetData_renamed_SDL_GetSensorData`"); // /usr/include/SDL3/SDL_oldnames.h:1238:9
pub const SDL_SensorGetInstanceID = @compileError("unable to translate macro: undefined identifier `SDL_SensorGetInstanceID_renamed_SDL_GetSensorID`"); // /usr/include/SDL3/SDL_oldnames.h:1239:9
pub const SDL_SensorGetName = @compileError("unable to translate macro: undefined identifier `SDL_SensorGetName_renamed_SDL_GetSensorName`"); // /usr/include/SDL3/SDL_oldnames.h:1240:9
pub const SDL_SensorGetNonPortableType = @compileError("unable to translate macro: undefined identifier `SDL_SensorGetNonPortableType_renamed_SDL_GetSensorNonPortableType`"); // /usr/include/SDL3/SDL_oldnames.h:1241:9
pub const SDL_SensorGetType = @compileError("unable to translate macro: undefined identifier `SDL_SensorGetType_renamed_SDL_GetSensorType`"); // /usr/include/SDL3/SDL_oldnames.h:1242:9
pub const SDL_SensorOpen = @compileError("unable to translate macro: undefined identifier `SDL_SensorOpen_renamed_SDL_OpenSensor`"); // /usr/include/SDL3/SDL_oldnames.h:1243:9
pub const SDL_SensorUpdate = @compileError("unable to translate macro: undefined identifier `SDL_SensorUpdate_renamed_SDL_UpdateSensors`"); // /usr/include/SDL3/SDL_oldnames.h:1244:9
pub const SDL_FALSE = @compileError("unable to translate macro: undefined identifier `SDL_FALSE_renamed_false`"); // /usr/include/SDL3/SDL_oldnames.h:1247:9
pub const SDL_TABLESIZE = @compileError("unable to translate macro: undefined identifier `SDL_TABLESIZE_renamed_SDL_arraysize`"); // /usr/include/SDL3/SDL_oldnames.h:1248:9
pub const SDL_TRUE = @compileError("unable to translate macro: undefined identifier `SDL_TRUE_renamed_true`"); // /usr/include/SDL3/SDL_oldnames.h:1249:9
pub const SDL_bool = @compileError("unable to translate macro: undefined identifier `SDL_bool_renamed_bool`"); // /usr/include/SDL3/SDL_oldnames.h:1250:9
pub const SDL_size_add_overflow = @compileError("unable to translate macro: undefined identifier `SDL_size_add_overflow_renamed_SDL_size_add_check_overflow`"); // /usr/include/SDL3/SDL_oldnames.h:1251:9
pub const SDL_size_mul_overflow = @compileError("unable to translate macro: undefined identifier `SDL_size_mul_overflow_renamed_SDL_size_mul_check_overflow`"); // /usr/include/SDL3/SDL_oldnames.h:1252:9
pub const SDL_strtokr = @compileError("unable to translate macro: undefined identifier `SDL_strtokr_renamed_SDL_strtok_r`"); // /usr/include/SDL3/SDL_oldnames.h:1253:9
pub const SDL_BlitScaled = @compileError("unable to translate macro: undefined identifier `SDL_BlitScaled_renamed_SDL_BlitSurfaceScaled`"); // /usr/include/SDL3/SDL_oldnames.h:1256:9
pub const SDL_ConvertSurfaceFormat = @compileError("unable to translate macro: undefined identifier `SDL_ConvertSurfaceFormat_renamed_SDL_ConvertSurface`"); // /usr/include/SDL3/SDL_oldnames.h:1257:9
pub const SDL_FillRect = @compileError("unable to translate macro: undefined identifier `SDL_FillRect_renamed_SDL_FillSurfaceRect`"); // /usr/include/SDL3/SDL_oldnames.h:1258:9
pub const SDL_FillRects = @compileError("unable to translate macro: undefined identifier `SDL_FillRects_renamed_SDL_FillSurfaceRects`"); // /usr/include/SDL3/SDL_oldnames.h:1259:9
pub const SDL_FreeSurface = @compileError("unable to translate macro: undefined identifier `SDL_FreeSurface_renamed_SDL_DestroySurface`"); // /usr/include/SDL3/SDL_oldnames.h:1260:9
pub const SDL_GetClipRect = @compileError("unable to translate macro: undefined identifier `SDL_GetClipRect_renamed_SDL_GetSurfaceClipRect`"); // /usr/include/SDL3/SDL_oldnames.h:1261:9
pub const SDL_GetColorKey = @compileError("unable to translate macro: undefined identifier `SDL_GetColorKey_renamed_SDL_GetSurfaceColorKey`"); // /usr/include/SDL3/SDL_oldnames.h:1262:9
pub const SDL_HasColorKey = @compileError("unable to translate macro: undefined identifier `SDL_HasColorKey_renamed_SDL_SurfaceHasColorKey`"); // /usr/include/SDL3/SDL_oldnames.h:1263:9
pub const SDL_HasSurfaceRLE = @compileError("unable to translate macro: undefined identifier `SDL_HasSurfaceRLE_renamed_SDL_SurfaceHasRLE`"); // /usr/include/SDL3/SDL_oldnames.h:1264:9
pub const SDL_LoadBMP_RW = @compileError("unable to translate macro: undefined identifier `SDL_LoadBMP_RW_renamed_SDL_LoadBMP_IO`"); // /usr/include/SDL3/SDL_oldnames.h:1265:9
pub const SDL_LowerBlit = @compileError("unable to translate macro: undefined identifier `SDL_LowerBlit_renamed_SDL_BlitSurfaceUnchecked`"); // /usr/include/SDL3/SDL_oldnames.h:1266:9
pub const SDL_LowerBlitScaled = @compileError("unable to translate macro: undefined identifier `SDL_LowerBlitScaled_renamed_SDL_BlitSurfaceUncheckedScaled`"); // /usr/include/SDL3/SDL_oldnames.h:1267:9
pub const SDL_PREALLOC = @compileError("unable to translate macro: undefined identifier `SDL_PREALLOC_renamed_SDL_SURFACE_PREALLOCATED`"); // /usr/include/SDL3/SDL_oldnames.h:1268:9
pub const SDL_SIMD_ALIGNED = @compileError("unable to translate macro: undefined identifier `SDL_SIMD_ALIGNED_renamed_SDL_SURFACE_SIMD_ALIGNED`"); // /usr/include/SDL3/SDL_oldnames.h:1269:9
pub const SDL_SaveBMP_RW = @compileError("unable to translate macro: undefined identifier `SDL_SaveBMP_RW_renamed_SDL_SaveBMP_IO`"); // /usr/include/SDL3/SDL_oldnames.h:1270:9
pub const SDL_SetClipRect = @compileError("unable to translate macro: undefined identifier `SDL_SetClipRect_renamed_SDL_SetSurfaceClipRect`"); // /usr/include/SDL3/SDL_oldnames.h:1271:9
pub const SDL_SetColorKey = @compileError("unable to translate macro: undefined identifier `SDL_SetColorKey_renamed_SDL_SetSurfaceColorKey`"); // /usr/include/SDL3/SDL_oldnames.h:1272:9
pub const SDL_UpperBlit = @compileError("unable to translate macro: undefined identifier `SDL_UpperBlit_renamed_SDL_BlitSurface`"); // /usr/include/SDL3/SDL_oldnames.h:1273:9
pub const SDL_UpperBlitScaled = @compileError("unable to translate macro: undefined identifier `SDL_UpperBlitScaled_renamed_SDL_BlitSurfaceScaled`"); // /usr/include/SDL3/SDL_oldnames.h:1274:9
pub const SDL_AndroidBackButton = @compileError("unable to translate macro: undefined identifier `SDL_AndroidBackButton_renamed_SDL_SendAndroidBackButton`"); // /usr/include/SDL3/SDL_oldnames.h:1277:9
pub const SDL_AndroidGetActivity = @compileError("unable to translate macro: undefined identifier `SDL_AndroidGetActivity_renamed_SDL_GetAndroidActivity`"); // /usr/include/SDL3/SDL_oldnames.h:1278:9
pub const SDL_AndroidGetExternalStoragePath = @compileError("unable to translate macro: undefined identifier `SDL_AndroidGetExternalStoragePath_renamed_SDL_GetAndroidExternalStoragePath`"); // /usr/include/SDL3/SDL_oldnames.h:1279:9
pub const SDL_AndroidGetExternalStorageState = @compileError("unable to translate macro: undefined identifier `SDL_AndroidGetExternalStorageState_renamed_SDL_GetAndroidExternalStorageState`"); // /usr/include/SDL3/SDL_oldnames.h:1280:9
pub const SDL_AndroidGetInternalStoragePath = @compileError("unable to translate macro: undefined identifier `SDL_AndroidGetInternalStoragePath_renamed_SDL_GetAndroidInternalStoragePath`"); // /usr/include/SDL3/SDL_oldnames.h:1281:9
pub const SDL_AndroidGetJNIEnv = @compileError("unable to translate macro: undefined identifier `SDL_AndroidGetJNIEnv_renamed_SDL_GetAndroidJNIEnv`"); // /usr/include/SDL3/SDL_oldnames.h:1282:9
pub const SDL_AndroidRequestPermission = @compileError("unable to translate macro: undefined identifier `SDL_AndroidRequestPermission_renamed_SDL_RequestAndroidPermission`"); // /usr/include/SDL3/SDL_oldnames.h:1283:9
pub const SDL_AndroidRequestPermissionCallback = @compileError("unable to translate macro: undefined identifier `SDL_AndroidRequestPermissionCallback_renamed_SDL_RequestAndroidPermissionCallback`"); // /usr/include/SDL3/SDL_oldnames.h:1284:9
pub const SDL_AndroidSendMessage = @compileError("unable to translate macro: undefined identifier `SDL_AndroidSendMessage_renamed_SDL_SendAndroidMessage`"); // /usr/include/SDL3/SDL_oldnames.h:1285:9
pub const SDL_AndroidShowToast = @compileError("unable to translate macro: undefined identifier `SDL_AndroidShowToast_renamed_SDL_ShowAndroidToast`"); // /usr/include/SDL3/SDL_oldnames.h:1286:9
pub const SDL_DXGIGetOutputInfo = @compileError("unable to translate macro: undefined identifier `SDL_DXGIGetOutputInfo_renamed_SDL_GetDXGIOutputInfo`"); // /usr/include/SDL3/SDL_oldnames.h:1287:9
pub const SDL_Direct3D9GetAdapterIndex = @compileError("unable to translate macro: undefined identifier `SDL_Direct3D9GetAdapterIndex_renamed_SDL_GetDirect3D9AdapterIndex`"); // /usr/include/SDL3/SDL_oldnames.h:1288:9
pub const SDL_GDKGetDefaultUser = @compileError("unable to translate macro: undefined identifier `SDL_GDKGetDefaultUser_renamed_SDL_GetGDKDefaultUser`"); // /usr/include/SDL3/SDL_oldnames.h:1289:9
pub const SDL_GDKGetTaskQueue = @compileError("unable to translate macro: undefined identifier `SDL_GDKGetTaskQueue_renamed_SDL_GetGDKTaskQueue`"); // /usr/include/SDL3/SDL_oldnames.h:1290:9
pub const SDL_LinuxSetThreadPriority = @compileError("unable to translate macro: undefined identifier `SDL_LinuxSetThreadPriority_renamed_SDL_SetLinuxThreadPriority`"); // /usr/include/SDL3/SDL_oldnames.h:1291:9
pub const SDL_LinuxSetThreadPriorityAndPolicy = @compileError("unable to translate macro: undefined identifier `SDL_LinuxSetThreadPriorityAndPolicy_renamed_SDL_SetLinuxThreadPriorityAndPolicy`"); // /usr/include/SDL3/SDL_oldnames.h:1292:9
pub const SDL_OnApplicationDidBecomeActive = @compileError("unable to translate macro: undefined identifier `SDL_OnApplicationDidBecomeActive_renamed_SDL_OnApplicationDidEnterForeground`"); // /usr/include/SDL3/SDL_oldnames.h:1293:9
pub const SDL_OnApplicationWillResignActive = @compileError("unable to translate macro: undefined identifier `SDL_OnApplicationWillResignActive_renamed_SDL_OnApplicationWillEnterBackground`"); // /usr/include/SDL3/SDL_oldnames.h:1294:9
pub const SDL_iOSSetAnimationCallback = @compileError("unable to translate macro: undefined identifier `SDL_iOSSetAnimationCallback_renamed_SDL_SetiOSAnimationCallback`"); // /usr/include/SDL3/SDL_oldnames.h:1295:9
pub const SDL_iOSSetEventPump = @compileError("unable to translate macro: undefined identifier `SDL_iOSSetEventPump_renamed_SDL_SetiOSEventPump`"); // /usr/include/SDL3/SDL_oldnames.h:1296:9
pub const SDL_iPhoneSetAnimationCallback = @compileError("unable to translate macro: undefined identifier `SDL_iPhoneSetAnimationCallback_renamed_SDL_iOSSetAnimationCallback`"); // /usr/include/SDL3/SDL_oldnames.h:1297:9
pub const SDL_iPhoneSetEventPump = @compileError("unable to translate macro: undefined identifier `SDL_iPhoneSetEventPump_renamed_SDL_iOSSetEventPump`"); // /usr/include/SDL3/SDL_oldnames.h:1298:9
pub const SDL_SetThreadPriority = @compileError("unable to translate macro: undefined identifier `SDL_SetThreadPriority_renamed_SDL_SetCurrentThreadPriority`"); // /usr/include/SDL3/SDL_oldnames.h:1301:9
pub const SDL_SetWindowInputFocus = @compileError("unable to translate macro: undefined identifier `SDL_SetWindowInputFocus_deprecated_use_SDL_RaiseWindow`"); // /usr/include/SDL3/SDL_oldnames.h:1302:9
pub const SDL_TLSCleanup = @compileError("unable to translate macro: undefined identifier `SDL_TLSCleanup_renamed_SDL_CleanupTLS`"); // /usr/include/SDL3/SDL_oldnames.h:1303:9
pub const SDL_TLSGet = @compileError("unable to translate macro: undefined identifier `SDL_TLSGet_renamed_SDL_GetTLS`"); // /usr/include/SDL3/SDL_oldnames.h:1304:9
pub const SDL_TLSSet = @compileError("unable to translate macro: undefined identifier `SDL_TLSSet_renamed_SDL_SetTLS`"); // /usr/include/SDL3/SDL_oldnames.h:1305:9
pub const SDL_threadID = @compileError("unable to translate macro: undefined identifier `SDL_threadID_renamed_SDL_ThreadID`"); // /usr/include/SDL3/SDL_oldnames.h:1306:9
pub const SDL_GetTicks64 = @compileError("unable to translate macro: undefined identifier `SDL_GetTicks64_renamed_SDL_GetTicks`"); // /usr/include/SDL3/SDL_oldnames.h:1309:9
pub const SDL_COMPILEDVERSION = @compileError("unable to translate macro: undefined identifier `SDL_COMPILEDVERSION_renamed_SDL_VERSION`"); // /usr/include/SDL3/SDL_oldnames.h:1312:9
pub const SDL_PATCHLEVEL = @compileError("unable to translate macro: undefined identifier `SDL_PATCHLEVEL_renamed_SDL_MICRO_VERSION`"); // /usr/include/SDL3/SDL_oldnames.h:1313:9
pub const SDL_GL_DeleteContext = @compileError("unable to translate macro: undefined identifier `SDL_GL_DeleteContext_renamed_SDL_GL_DestroyContext`"); // /usr/include/SDL3/SDL_oldnames.h:1316:9
pub const SDL_GLattr = @compileError("unable to translate macro: undefined identifier `SDL_GLattr_renamed_SDL_GLAttr`"); // /usr/include/SDL3/SDL_oldnames.h:1317:9
pub const SDL_GLcontextFlag = @compileError("unable to translate macro: undefined identifier `SDL_GLcontextFlag_renamed_SDL_GLContextFlag`"); // /usr/include/SDL3/SDL_oldnames.h:1318:9
pub const SDL_GLcontextReleaseFlag = @compileError("unable to translate macro: undefined identifier `SDL_GLcontextReleaseFlag_renamed_SDL_GLContextReleaseFlag`"); // /usr/include/SDL3/SDL_oldnames.h:1319:9
pub const SDL_GLprofile = @compileError("unable to translate macro: undefined identifier `SDL_GLprofile_renamed_SDL_GLProfile`"); // /usr/include/SDL3/SDL_oldnames.h:1320:9
pub const SDL_GetClosestDisplayMode = @compileError("unable to translate macro: undefined identifier `SDL_GetClosestDisplayMode_renamed_SDL_GetClosestFullscreenDisplayMode`"); // /usr/include/SDL3/SDL_oldnames.h:1321:9
pub const SDL_GetDisplayOrientation = @compileError("unable to translate macro: undefined identifier `SDL_GetDisplayOrientation_renamed_SDL_GetCurrentDisplayOrientation`"); // /usr/include/SDL3/SDL_oldnames.h:1322:9
pub const SDL_GetPointDisplayIndex = @compileError("unable to translate macro: undefined identifier `SDL_GetPointDisplayIndex_renamed_SDL_GetDisplayForPoint`"); // /usr/include/SDL3/SDL_oldnames.h:1323:9
pub const SDL_GetRectDisplayIndex = @compileError("unable to translate macro: undefined identifier `SDL_GetRectDisplayIndex_renamed_SDL_GetDisplayForRect`"); // /usr/include/SDL3/SDL_oldnames.h:1324:9
pub const SDL_GetWindowDisplayIndex = @compileError("unable to translate macro: undefined identifier `SDL_GetWindowDisplayIndex_renamed_SDL_GetDisplayForWindow`"); // /usr/include/SDL3/SDL_oldnames.h:1325:9
pub const SDL_GetWindowDisplayMode = @compileError("unable to translate macro: undefined identifier `SDL_GetWindowDisplayMode_renamed_SDL_GetWindowFullscreenMode`"); // /usr/include/SDL3/SDL_oldnames.h:1326:9
pub const SDL_HasWindowSurface = @compileError("unable to translate macro: undefined identifier `SDL_HasWindowSurface_renamed_SDL_WindowHasSurface`"); // /usr/include/SDL3/SDL_oldnames.h:1327:9
pub const SDL_INIT_EVERYTHING = @compileError("unable to translate macro: undefined identifier `SDL_INIT_EVERYTHING_deprecated_list_flags_explicitly`"); // /usr/include/SDL3/SDL_oldnames.h:1328:9
pub const SDL_IsScreenSaverEnabled = @compileError("unable to translate macro: undefined identifier `SDL_IsScreenSaverEnabled_renamed_SDL_ScreenSaverEnabled`"); // /usr/include/SDL3/SDL_oldnames.h:1329:9
pub const SDL_SetWindowDisplayMode = @compileError("unable to translate macro: undefined identifier `SDL_SetWindowDisplayMode_renamed_SDL_SetWindowFullscreenMode`"); // /usr/include/SDL3/SDL_oldnames.h:1330:9
pub const SDL_WINDOW_ALLOW_HIGHDPI = @compileError("unable to translate macro: undefined identifier `SDL_WINDOW_ALLOW_HIGHDPI_renamed_SDL_WINDOW_HIGH_PIXEL_DENSITY`"); // /usr/include/SDL3/SDL_oldnames.h:1331:9
pub const SDL_WINDOW_FULLSCREEN_DESKTOP = @compileError("unable to translate macro: undefined identifier `SDL_WINDOW_FULLSCREEN_DESKTOP_deprecated_use_SDL_SetWindowFullscreen_with_bool`"); // /usr/include/SDL3/SDL_oldnames.h:1332:9
pub const SDL_WINDOW_INPUT_GRABBED = @compileError("unable to translate macro: undefined identifier `SDL_WINDOW_INPUT_GRABBED_renamed_SDL_WINDOW_MOUSE_GRABBED`"); // /usr/include/SDL3/SDL_oldnames.h:1333:9
pub const SDL_WINDOW_SHOWN = @compileError("unable to translate macro: undefined identifier `SDL_WINDOW_SHOWN_deprecated_windows_are_shown_by_default`"); // /usr/include/SDL3/SDL_oldnames.h:1334:9
pub const SDL_WINDOW_SKIP_TASKBAR = @compileError("unable to translate macro: undefined identifier `SDL_WINDOW_SKIP_TASKBAR_renamed_SDL_WINDOW_UTILITY`"); // /usr/include/SDL3/SDL_oldnames.h:1335:9
